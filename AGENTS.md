...
**955 curated notes** on peer-reviewed papers in management and business
...
and 683 Academy of Management Journal pilot notes across 55 recent issues
(vol. 60 no. 1 through vol. 69 no. 1). Every note is a single Markdown
...
**Current main-branch audit state (2026-07-03):
955 / 955 notes PASS, 0 UNSUPPORTED, 0 CONTRADICTED.** The corpus contains
88 legacy v1 notes and 867 v2 notes with evidence anchors. `PARTIAL`
...
**Caveats:**
- Notes are a snapshot, not a live database. The current main-branch audit state was checked locally on 2026-07-03.
...
> Tang, B. (2026). *Management Research Notes: A File-Based Academic Knowledge Base for Management and Business Sustainability Research* (Version 0.27.0) [Software]. Zenodo. https://doi.org/10.5281/zenodo.19564336
