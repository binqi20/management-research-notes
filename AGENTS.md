...
**147 curated notes** on peer-reviewed papers in management and business
...
across vol-67-6, vol-68-1, vol-68-2, vol-68-3, vol-68-4, vol-68-5,
vol-68-6, and vol-69-1 — 70 notes). Every note is a single Markdown
file with YAML frontmatter and a structured Markdown body. The
repository is MIT licensed; individual PDFs are not redistributed.
...
**Full-library sweep result (2026-05-05, v0.8.0):
147 / 147 notes PASS, 0 UNSUPPORTED, 0 CONTRADICTED.** The full verdict
...
human review but do not block publication. Across seven release cycles
(v0.2.0 → v0.3.0 → v0.4.0 → v0.5.0 → v0.6.0 → v0.7.0 → v0.8.0) the
library has never produced a `CONTRADICTED` verdict — no claim in any
note actively contradicts its source paper.
...
> Tang, B. (2026). *Management Research Notes: A File-Based Academic Knowledge Base for Management and Business Sustainability Research* (Version 0.8.0) [Software]. Zenodo. https://doi.org/10.5281/zenodo.19564336
