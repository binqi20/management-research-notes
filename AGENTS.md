...
**767 curated notes** on peer-reviewed papers in management and business
...
and 495 Academy of Management Journal notes across 43 recent issues
(vol. 62 no. 1 through vol. 69 no. 1). Every note is a single Markdown
...
**Current main-branch audit state (2026-06-30):
767 / 767 notes PASS, 0 UNSUPPORTED, 0 CONTRADICTED.** The corpus contains
88 legacy v1 notes and 679 v2 notes with evidence anchors. `PARTIAL`
...
> Tang, B. (2026). *Management Research Notes: A File-Based Academic Knowledge Base for Management and Business Sustainability Research* (Version 0.25.0) [Software]. Zenodo. https://doi.org/10.5281/zenodo.19564336
