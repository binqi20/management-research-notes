...
**860 curated notes** on peer-reviewed papers in management and business
...
and 588 Academy of Management Journal notes across 49 recent issues
(vol. 61 no. 1 through vol. 69 no. 1). Every note is a single Markdown
...
**Current main-branch audit state (2026-07-02):
860 / 860 notes PASS, 0 UNSUPPORTED, 0 CONTRADICTED.** The corpus contains
88 legacy v1 notes and 772 v2 notes with evidence anchors. `PARTIAL`
...
> Tang, B. (2026). *Management Research Notes: A File-Based Academic Knowledge Base for Management and Business Sustainability Research* (Version 0.26.0) [Software]. Zenodo. https://doi.org/10.5281/zenodo.19564336
