...
[![Notes](https://img.shields.io/badge/curated%20notes-165-brightgreen.svg)](notes/)
[![Sources](https://img.shields.io/badge/sources-NBS%20%2B%20AMJ-orange.svg)](#whats-in-this-release)
[![Audit](https://img.shields.io/badge/audit-165%2F165%20PASS-success.svg)](#faithfulness-audit)
...
- **v0.10.0 sweep (2026-05-06, full 165 notes):**
  **165 / 165 PASS, 0 UNSUPPORTED, 0 CONTRADICTED.** Nine new notes
  added from AMJ vol. 67 no. 4 (Bliese editorial + 8 substantive
  papers). Only 1 PARTIAL across 54 audits (Wu 2023 limitations —
  k/n parametric choices framed as Methods trade-offs rather than
  in dedicated Limitations section; framing nuance). Heaviest
  sandwich-truncation batch yet: 5 of 9 papers triggered the
  sandwich (Grimm, Pletneva, Rapp, Shi, Yiu), all resolved to
  all-SUPPORTED — the previously truncation-driven PARTIAL pattern
  is now reliably resolved. Across nine release cycles the library
  has produced zero CONTRADICTED verdicts.
...
This release contains **165 curated notes** across two source streams:
...
- **AMJ pilot** — 88 notes across ten recent issues of the
  [Academy of Management Journal](https://journals.aom.org/journal/amj)
  (vol. 67 no. 4, vol. 67 no. 5, vol. 67 no. 6, vol. 68 no. 1, vol. 68
  no. 2, vol. 68 no. 3, vol. 68 no. 4, vol. 68 no. 5, vol. 68 no. 6,
  vol. 69 no. 1). v0.10.0 added vol. 67 no. 4 (9 notes); v0.9.0 added
  vol. 67 no. 5 (9 notes); v0.8.0 added vol. 67 no. 6 (8 notes); v0.7.0
...
| Paper type             | Count |
|------------------------|------:|
| empirical-quantitative |    67 |
| empirical-qualitative  |    46 |
| conceptual             |    19 |
| editorial              |    14 |
| empirical-mixed        |    12 |
| review                 |     4 |
...
├── notes/                             ← 165 curated paper notes (the source of truth)
