---
id: amj-vol-58-no-2-chuang-2015
...
doi: "https://doi.org/10.5465/amj.2012.1076"
volume: 58
issue: 2
pages: "480-510"

source: "AMJ/vol-58-no-2"
pdf_path: "library/AMJ/vol-58-no-2/pdfs/Chuang 2015 Does West “Fit” with East In Search of a Chinese Model of Person–Environment Fit.pdf"
...
theory: ["person-environment fit theory", "Confucian relationalism", "Confucian selfhood"]
topics: ["organizational-behavior-hrm", "qualitative-methods", "asia"]
unit_of_analysis: "individual"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Qualitative study using semi-structured interviews, critical incident technique, purposive and theoretical sampling, line-by-line open coding, axial coding, cognitive mapping, and NVivo 9.0 analysis."
sample:
  industry: "Diverse industries including banking, media, retail, transportation, and service industries"
  country: "Taiwan"
  time_period: "15-week data collection period"
  units: "Chinese working adults and PE fit episodes"
  n: "30 Chinese informants; 611 usable episodes"

evidence:
  sample_n: "We interviewed a total of 30 Chinese informants"
  sample_country: "working adults in Taiwan"
  sample_industry: "diverse range of industries"
  sample_time_period: "continued for 15 weeks"
...
- Process structure: Input, throughput, and output processes through which informants locate the person and environment, interpret their interaction, and evaluate fit.
- Temporal structure: Retrospective and prospective temporal frames, plus diachronic attention to personal and environmental transformation.
...
The paper suggests that managers in Chinese contexts should design HR practices that support competence, relational harmony, work-family balance, learning, and opportunities to make meaningful changes at work. It highlights the value of feedback and approval for competent performance, interpersonal and team-management training, family-supportive work practices, developmental opportunities, and spaces for employees to realize constructive aspirations.

**Limitations**
The authors acknowledge that whether the Chinese PE fit themes replicate in other cultural settings or are unique to Chinese contexts is an empirical question. They also note that the study identifies meaningful themes but does not yet provide psychometrically sound measures or quantitative tests of validity, incremental validity, antecedents, consequences, mediating mechanisms, or boundary conditions.

**Future Research**
The authors encourage qualitative inquiry into PE fit in other parts of the world and further work on how misfit meanings vary across cultural settings. They call for measure development for the five Chinese PE fit themes and empirical tests of their validity, relationships, interactions, antecedents, consequences, and boundary conditions. They also encourage future research on how different time perspectives evolve in PE fit experiences.

**APA 7th Citation**
Chuang, A., Hsu, R. S., Wang, A.-C., & Judge, T. A. (2015). Does West “fit” with East? In search of a Chinese model of person-environment fit. *Academy of Management Journal*, 58(2), 480-510. https://doi.org/10.5465/amj.2012.1076
