---
id: amj-vol-58-no-2-dodgson-2015
...
doi: "https://doi.org/10.5465/amj.2015.4002"
volume: 58
issue: 2
pages: "325-333"

source: "AMJ/vol-58-no-2"
pdf_path: "library/AMJ/vol-58-no-2/pdfs/Dodgson 2015 Managing Digital Money.pdf"
...
theory: ["innovation ecosystems", "transaction cost economics", "institutional theory", "resource-based view", "dynamic capabilities theory"]
topics: ["digital-transformation", "innovation-management", "business-models", "developing-economies"]
unit_of_analysis: "multi-level"
level_of_theory: "cross-level"
dependent_variable_family: "na"
methods: "From the Editors editorial and agenda-setting essay that frames digital money as a transformational innovation, reviews platforms and readiness indexes, and identifies research opportunities for management scholars in innovation, entrepreneurship, trust, business models, competitiveness, regulation, and inclusive growth."
sample:
...
evidence:
  ...
  theories_overview: "The concept of innovation ecosystems helps"
  methods_overview: "FROM THE EDITORS"
  keywords_source: "Digital money dematerializes by moving"
---
...
- Innovation and entrepreneurship: Digital money creates opportunities for disruptive financial services, inclusive innovation, bottom-up entrepreneurship, new platforms, and new forms of consumer experience.
- Trust and governance: Disintermediation heightens concerns about privacy, cybersecurity, fraud, identity, distributed authenticity, regulation, and ethical service-provider behavior.
- Business models and competitiveness: Efficiency gains, new customer engagement models, transaction data, lower cash-handling costs, digital readiness, and capabilities for virtual transactions affect business growth and national competitiveness.
...
**Future Research**
Future research should examine how digital money affects business growth, competition, entrepreneurship, innovation ecosystems, technology standards, regulatory balance, auditing, trust, privacy, cybersecurity, business model innovation, national competitiveness, and financial inclusion. The editorial also calls for research on institutional readiness and adaptability as digital money changes technology, individual behavior, and the context of management.
