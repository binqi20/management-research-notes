---
id: amj-vol-58-no-2-patvardhan-2015
...
doi: "https://doi.org/10.5465/amj.2012.1049"
volume: 58
issue: 2
pages: "405-435"

source: "AMJ/vol-58-no-2"
pdf_path: "library/AMJ/vol-58-no-2/pdfs/Patvardhan 2015 Weathering a Meta-Level Identity Crisis Forging a Coherent Collective Identity for an Emerging Field.pdf"
...
theory: ["collective identity", "social construction view of identity", "identity work", "optimal distinctiveness", "institutional identity work"]
...
methods: "Longitudinal qualitative grounded-theory study of the iSchools field, using a cross-level organization-field design, semi-structured interviews, archival data, iConference attendance, non-participant observation, field notes, and open, axial, and theoretical coding."
sample:
  industry: "Academic information schools and the emerging iSchools field."
  country: "International iSchools consortium across 12 countries."
  time_period: "More than seven years, with primary data collection from 2004 through 2011 and archival coverage of earlier field formation."
  units: "Member iSchools, deans, faculty, staff, students, alumni, archival documents, and field events."
  n: "46 information schools in the consortium; 74 formal interviews; deans of all 31 schools in the population at the end of data collection."

# Mandatory evidence anchors (v2 - Layer 1 faithfulness audit).
evidence:
  sample_n: "Overall, we conducted 74"
  sample_country: "current membership of 46 schools in 12"
  sample_industry: "emerging consortium of academic"
  sample_time_period: "over a period of seven years"
...
- Triggering conditions: members came from older library science, computer science, information systems, and related fields, while also remaining embedded in universities, regions, and professional communities with their own identity expectations.
- Emergent outcomes: a coherent field-level identity became workable without full agreement on the meaning of every identity claim, and younger cohorts became more comfortable identifying with the iSchools field.
...
For leaders of emerging fields, the findings suggest that forcing early consensus on identity meanings can intensify conflict when members have heterogeneous histories and institutional embeddings. Field leaders may instead make progress by building shared agendas, common problem domains, and recurring practices that allow members to work together while retaining local variation. The study also suggests that ambiguity can be useful when it creates room for multiple member identities to fit within a broader collective identity.
