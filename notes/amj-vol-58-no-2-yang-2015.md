...
doi: "https://doi.org/10.5465/amj.2012.0675"
volume: 58
issue: 2
pages: "356-374"

source: "AMJ/vol-58-no-2"
pdf_path: "library/AMJ/vol-58-no-2/pdfs/Yang 2015 Asymmetric Learning Capabilities and Stock Market Returns.pdf"
...
theory: ["alliance learning", "learning race", "partner-specific absorptive capacity", "private and common benefits in alliances"]
topics: ["strategy-innovation", "innovation-management"]
unit_of_analysis: "firm"
level_of_theory: "meso"
dependent_variable_family: "financial"
methods: "Empirical quantitative event study of R&D alliance announcements. The authors use SDC Platinum and rDNA alliance data, Lexis/Nexis and Factiva announcement dates, CRSP stock returns, Compustat and Bioscan firm data, USPTO patent citations, Heckman two-stage selection correction, ordinary least squares regressions, and robust standard errors clustered by firm."
sample:
  industry: "U.S. computing and biopharmaceutical industries."
  country: "United States."
  time_period: "Alliance formations and patent-citation windows covering 1984-2003."
  units: "Public-firm observations nested in 610 R&D alliances; each alliance contributes two firm-level observations."
  n: "610 R&D alliances with complete data; 1,140 firm-level observations in the CAR regressions."

# Mandatory evidence anchors (v2 - Layer 1 faithfulness audit).
evidence:
  sample_n: "610 R&D alliances with complete data for analyses"
  sample_country: "U.S. computing and biopharmaceutical industries"
  sample_industry: "computing and biopharmaceutical industries"
  sample_time_period: "period 1984 to 2003"
...
- Moderators: Equity alliance governance and market similarity between alliance partners.
...
**APA 7th Citation**
Yang, H., Zheng, Y., & Zaheer, A. (2015). Asymmetric learning capabilities and stock market returns. *Academy of Management Journal*, 58(2), 356-374. https://doi.org/10.5465/amj.2012.0675
