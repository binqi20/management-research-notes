...
doi: "https://doi.org/10.5465/amj.2013.0949"
volume: 58
issue: 4
pages: "1032-1050"

source: "AMJ/vol-58-no-4"
pdf_path: "library/AMJ/vol-58-no-4/pdfs/Desai 2015 Learning Through the Distribution of Failures within an Organization Evidence from Heart Bypass Surgery Performance.pdf"
...
theory: ["organizational learning theory (Argote & Miron-Spektor, 2011; Levitt & March, 1988)", "attribution theory (Burger, 1981; Ford, 1985)"]
topics: ["organizational-behavior-hrm", "quantitative-methods", "attribution-theory", "north-america"]
unit_of_analysis: "organization"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Longitudinal panel study of California hospitals offering CABG surgery, using lagged predictors and feasible generalized least squares regression to estimate risk-adjusted mortality rates, with supplemental analyses of hospital responses, surgeon turnover, and IMA graft usage."
sample:
  industry: "Hospitals offering coronary artery bypass graft (CABG) surgery."
  country: "United States, specifically California."
  time_period: "2003 through 2010, organized into four two-year reporting periods; estimation uses lagged predictors from 2005 through 2010."
  units: "Hospital-period observations."
  n: "468 hospital-period observations in the study panel; final FGLS models report N = 315 after lagging and model restrictions."

evidence:
  sample_n: "468 hospital-period observations"
  sample_country: "within California"
  sample_industry: "performing CABG surgery within California"
  sample_time_period: "from 2003 through 2010 (a total of four periods)"
...
- Mediators: Managerial attribution and the breadth of failure investigation are theorized but not directly measured as mediators.
...
Managers should not assume that repeated failures tied to the same individual or unit are fully explained by that local source. Even when removal, discipline, or retraining seems appropriate, leaders should also examine whether shared procedures, technologies, routines, or organizational conditions contributed to the failures. The hospital evidence suggests that dispersed failures are more likely to trigger procedural change, whereas concentrated failures may encourage turnover without equivalent process improvement.
