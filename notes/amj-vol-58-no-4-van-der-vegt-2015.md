---
id: amj-vol-58-no-4-van-der-vegt-2015
...
doi: "https://doi.org/10.5465/amj.2015.4004"
volume: 58
issue: 4
pages: "971-980"

source: "AMJ/vol-58-no-4"
pdf_path: "library/AMJ/vol-58-no-4/pdfs/Vegt 2015 Managing Risk and Resilience.pdf"
...
theory: ["organizational resilience (Sutcliffe & Vogus, 2003; Weick & Sutcliffe, 2001)", "contingency theory (Lawrence & Lorsch, 1967)", "social capital (Lin, 1999)", "network theory (Burt, 1992; Barabási, 2003)"]
topics: ["risk-management", "supply-chain-management", "public-policy", "grand-challenges"]
unit_of_analysis: "multi-level"
level_of_theory: "cross-level"
dependent_variable_family: "na"
methods: "From the Editors thematic editorial and research agenda synthesizing disaster, crisis, organizational resilience, networks, supply chains, governance, and research-design literatures; no empirical sample or estimation is reported."
sample:
...
evidence:
  ...
  theories_overview: "Contingency theory suggests that"
  methods_overview: "FROM THE EDITORS"
  keywords_source: "MANAGING RISK AND RESILIENCE"
---
...
For managers and policy makers, the editorial implies that resilience requires more than identifying risks in advance. Organizations should build flexible resources, decentralized decision structures, supply chain visibility, interorganizational collaboration, and public-private-civil society coordination that can support response and recovery when disruptive events occur.

**Limitations**
The article is an editorial research agenda, not a systematic review or empirical test. It explicitly notes that empirical research on organizational resilience is scarce, that much supply chain resilience research is conceptual, and that measuring organizational resilience is difficult because organizations are complex, large-scale systems with varied tasks and performance criteria.

**Future Research**
The editorial calls for management research on how individuals, teams, organizations, networks, supply chains, and tri-sector collaborations become vulnerable, robust, and able to recover from adverse events. It also recommends experimental designs, interrupted time-series designs, archival indicators, employee surveys, disaster reports, and multilevel dynamic approaches to examine the drivers and consequences of organizational resilience.
