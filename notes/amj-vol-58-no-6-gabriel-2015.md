---
id: amj-vol-58-no-6-gabriel-2015
...
doi: "https://doi.org/10.5465/amj.2013.1135"
volume: 58
issue: 6
pages: "1804-1825"

source: "AMJ/vol-58-no-6"
pdf_path: "library/AMJ/vol-58-no-6/pdfs/Gabriel 2015 Emotional Labor Dynamics A Momentary Approach.pdf"
...
theory: ["control theory models of behavioral self-regulation (Carver & Scheier, 1998)", "self-regulatory view of emotional labor (Diefendorff & Gosserand, 2003; Diefendorff & Richard, 2008)", "social interaction model of emotion regulation (Cote, 2005)"]
topics: ["organizational-behavior-hrm", "emotions-at-work", "experiments", "quantitative-methods"]
unit_of_analysis: "individual"
level_of_theory: "micro"
dependent_variable_family: "social"
methods: "Laboratory call center simulation with 76 undergraduate participants, manipulated customer civility across three phases, continuous participant ratings of felt emotions, surface acting, and deep acting every 200 milliseconds during call playback, third-party ratings of vocal tone, multilevel growth models, and within-person path analysis with 10-second lags."
sample:
  industry: "Simulated call center service interaction."
  country: "Not reported in paper"
  time_period: "Not reported in paper"
  units: "Undergraduate participants acting as call center employees in a single customer-service call."
  n: "76 participants after eight exclusions from 84 recruited participants."

# Mandatory evidence anchors (v2 - Layer 1 faithfulness audit).
evidence:
  sample_n: "The resulting sample of 76 participants"
  sample_country: "Not reported in paper"
  sample_industry: "a call center simulation"
...
- Mediators: Surface acting and deep acting are modeled as regulation processes linking felt emotions to vocal tone, but the specific indirect effects through these regulation strategies are small and not conventionally significant when modeled together with the stronger felt-emotion and vocal-tone pathways.
...
The findings imply that customer incivility in call centers and service work can quickly increase employees' negative feelings and regulation demands, even within a brief interaction. They also suggest that service recovery can restore more positive affect and reduce regulation needs after incivility. Managers may therefore benefit from training employees in service recovery, providing respite after difficult encounters, and helping employees detach from negative experiences or process them with coworkers.

**Limitations**
The study used one simulated call with undergraduate participants rather than multiple calls handled by actual call center workers, which limits direct generalization to full call center work. The continuous ratings were made retrospectively while participants listened back to recordings, raising the possibility of slight retrospection bias. The authors also note that the 10-second lag used to model causal ordering was partly arbitrary, even though supplemental analyses showed similar patterns across other lag lengths.

**Future Research**
Future research should examine multiple calls to test carryover between interactions and changing trajectories across a work shift. The authors encourage studies using actual call center workers and recordings of real customer calls, paired with postshift continuous ratings and customer or supervisor evaluations. They also call for work on emotional authenticity, separate continuous ratings of faking and suppression, display-rule perceptions, individual differences, micro-events within interactions, and thresholds at which incivility leads employees to abandon display rules.
