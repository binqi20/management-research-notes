---
id: amj-vol-58-no-6-george-2015
...
doi: "https://doi.org/10.5465/amj.2015.4006"
volume: 58
issue: 6
pages: "1595-1613"

source: "AMJ/vol-58-no-6"
pdf_path: "library/AMJ/vol-58-no-6/pdfs/George 2015 The Management of Natural Resources An Overview and Research Agenda.pdf"
...
theory: ["resource-based view (Barney, 1991)", "institutional theory", "resource dependence theory", "population ecology"]
topics: ["sustainability-environment", "environmental-regulation", "sustainable-operations", "theory-development"]
unit_of_analysis: "multi-level"
level_of_theory: "cross-level"
dependent_variable_family: "na"
methods: "From the Editors editorial and research agenda that reviews prior AMJ work on resources and natural resources, uses illustrative natural-resource scarcity cases, and develops practice-oriented themes from discussions with Teng Lit Liak."
sample:
...
evidence:
  ...
  methods_overview: "we review past work in AMJ"
  keywords_source: "THE MANAGEMENT OF NATURAL RESOURCES"
---
...
For managers and policymakers, the editorial implies that natural resource scarcity should be treated as a strategic and governance problem, not only as an environmental or engineering issue. It points to practical responses including supply-chain innovation, material efficiency, recycling and urban mining, frugal innovation, stakeholder engagement, public-private collaboration, and leadership that combines idealism with pragmatic experimentation.

**Limitations**
The article is an editorial overview and research agenda rather than a systematic review or empirical study. Its claims are grounded in selected AMJ patterns, illustrative resource-scarcity cases, and practice-oriented discussion, so it is designed to open research questions rather than test causal relationships.

**Future Research**
The editorial calls for research on how natural resource scarcity affects organizational responses, business-model innovation, government intervention, stakeholder engagement, social conflict, technology substitution, sustainability leadership, and cross-sector governance. It particularly encourages management scholars to study business, government, and civil society together as they respond to the scarcity and sustainability of Earth's natural resources.
