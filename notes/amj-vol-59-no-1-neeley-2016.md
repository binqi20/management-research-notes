---
id: amj-vol-59-no-1-neeley-2016
...
doi: "https://doi.org/10.5465/amj.2014.0535"
volume: 59
issue: 1
pages: "14-43"

source: "AMJ/vol-59-no-1"
pdf_path: "library/AMJ/vol-59-no-1/pdfs/Neeley 2016 Unearned Status Gain Evidence from a Global Language Mandate.pdf"
...
theory: ["status characteristics theory", "equity theory", "attribution theory", "perspective taking", "organizational identification"]
topics: ["organizational-behavior-hrm", "organizational-identity", "teams-collaboration", "attribution-theory"]
unit_of_analysis: "individual"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Inductive qualitative field study using semi-structured interviews with U.S.-based native English-speaking employees of a Japanese high-tech organization after an English language mandate, supplemented by Japanese employee and executive interviews and triangulated with organizational artifacts and observations."
sample:
  industry: "High-tech e-commerce / Internet marketplace organization"
  country: "United States subsidiaries of a Japanese organization, with supplemental Japanese informants"
  time_period: "15-month interview period, approximately one year after the English mandate"
  units: "U.S.-based native English-speaking employees, with supplemental Japanese executives, expatriates, and headquarters employees"
  n: "90 primary U.S.-based native English-speaking American employees; 66 supplemental Japanese interviews"

evidence:
  sample_n: "90 native English-speaking American employees"
  sample_country: "the northeast of the United"
  sample_industry: "multibillion-dollar high-tech organization"
  sample_time_period: "over a 15-month period"
...
Organizations should recognize that strategic changes such as language mandates alter status hierarchies, not only communication routines. Leaders need to support both disfavored employees and those favored by the change, because beneficiaries may experience uncertainty and unease alongside new opportunity. The paper suggests replacing a sense of luck with responsibility, using training, facilitation, and integration into core activities to help employees work across language and status differences.
