...
doi: "https://doi.org/10.5465/amj.2012.0098"
volume: 59
issue: 2
pages: "510-533"

source: "AMJ/vol-59-no-2"
pdf_path: "library/AMJ/vol-59-no-2/pdfs/Reuer 2016 Mechanisms of Hybrid Governance Administrative Committees in Non-Equity Alliances.pdf"
...
theory: ["transaction cost theory", "hybrid governance", "Williamson's theory of governance structures"]
topics: ["strategy-innovation", "mergers-acquisitions", "transaction-cost-theory", "quantitative-methods"]
unit_of_analysis: "dyad"
level_of_theory: "meso"
dependent_variable_family: "na"
methods: "Empirical quantitative study of non-equity alliances in the biopharmaceuticals industry. The paper uses probit models to estimate whether alliance contracts establish steering committees, with controls for partner experience, knowledge stocks, deal size, contract length, incentive payments, prior ties, deal type, cross-border status, phase, therapeutic area, technology area, and year."
sample:
  industry: "Biopharmaceutical alliances."
  country: "Domestic and cross-border alliances; individual countries are not listed."
  time_period: "Alliances formed during the 1990-2010 timeframe."
  units: "Non-equity alliance contracts between firms."
  n: "524 non-equity alliances."

evidence:
  sample_n: "a final sample of 524 non-equity alliances"
  sample_country: "involving partners from different countries"
  sample_industry: "alliances in the biopharmaceuticals industry"
  sample_time_period: "We focus on alliances formed during the 1990– Independent variables. Our first hypothesis 2010 timeframe."
...
**Future Research**
Future research could test whether the antecedents of steering committees generalize to other industries and collaborative contexts. Studies could examine longitudinal changes in committee existence, structure, responsibilities, and relationships with other control rights as alliances unfold. Additional work could investigate committee composition, attorney involvement, behavioral consequences, and whether administrative committees complement or substitute for relational governance mechanisms such as trust.
