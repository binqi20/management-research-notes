...
doi: "https://doi.org/10.5465/amj.2013.0657"
volume: 59
issue: 2
pages: "579-610"

source: "AMJ/vol-59-no-2"
pdf_path: "library/AMJ/vol-59-no-2/pdfs/York 2016 Converging Winds Logic Hybridization in the Colorado Wind Energy Field.pdf"
...
theory: ["institutional logics", "logic hybridization", "hybrid organizing", "social movement framing"]
topics: ["renewable-energy", "hybrid-organizations", "institutional-theory", "sustainability-environment"]
unit_of_analysis: "industry"
level_of_theory: "macro"
dependent_variable_family: "mixed"
methods: "Inductive historical case study of the Colorado wind energy field, using semi-structured interviews, naturalistic observation, newspaper articles, CPUC releases, utility archives, resource plans, archival reports, and video footage to build a process model of field-level logic hybridization."
sample:
  industry: "Colorado wind energy field."
  country: "Colorado, United States."
  time_period: "The case period is 1999-2008; supplementary data collection and archival coverage extend beyond that period."
  units: "Field actors including environmental SMOs, clean energy SMOs, wind energy firms, electric utilities, policy makers, regulators, researchers, attorneys, and related stakeholders."
  n: "34 interviews with 30 participants, 546 Denver Post articles, 58 CPUC press-release pages, 31 archived utility press releases, 10 resource plans, 1,781 pages of archival documents, and 12 videos."

evidence:
  sample_n: "34 interviews lasting between 60 minutes"
  sample_country: "wind energy in Colorado"
  sample_industry: "wind energy field in Colorado"
  sample_time_period: "for the period 1999–2008"
...
- Triggering conditions: High field centralization around Xcel and the CPUC, persistent logic incompatibility, and SMO frustration with compromise and assimilation.
- Emergent outcomes: A hybridized clean energy logic that constructed wind energy as simultaneously economically valuable and environmentally beneficial.
...
For advocates of environmentally relevant sectors, compromise with incumbents may build legitimacy and learning but may also reinforce the incumbent logic if the subordinate logic's goals remain unacknowledged. Contestation can become necessary when compromise and economic reframing fail to shift the field's power structure. Hybrid organizations are especially important because they can connect technical, market, policy, and movement work around a frame that makes economic and environmental goals mutually reinforcing.

**Limitations**
The authors note that all themes were triangulated from multiple data sources, but the study comes from a unique Colorado wind energy context. They frame the findings as most relevant to fields marked by high centralization and high perceived logic incompatibility; fields with more compatible logics may not require hybridization and may instead accommodate multiple logics through assimilation or blending.

**Future Research**
Future research could compare hybridization with blending and assimilation in other fields where practices are reconstructed to support previously incompatible goals. Additional studies could examine when developmental changes such as assimilation are necessary intermediary steps toward hybridization. The authors also call for further work on the internal tensions of hybrid organizations and on how those tensions affect field-level logic hybridization.
