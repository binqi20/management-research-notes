---
id: amj-vol-59-no-4-almandoz-2016
...
doi: "https://doi.org/10.5465/amj.2013.1211"
volume: 59
issue: 4
pages: "1124-1149"

source: "AMJ/vol-59-no-4"
pdf_path: "library/AMJ/vol-59-no-4/pdfs/Almandoz 2016 When Experts Become Liabilities Domain Experts on Boards and Organizational Failure.pdf"
...
theory: ["domain experts and decision-making groups", "decision uncertainty", "board composition"]
...
methods: "Empirical quantitative longitudinal study of U.S. local banks. The authors link directors' professional biographies to bank failure data and estimate competing-risks regression models, with inverse-probability-of-treatment weighting to address observable differences in banks' propensity to have expert-heavy boards."
sample:
  industry: "Local banks, or community banks"
  country: "United States"
  time_period: "Banks founded between 1996 and 2012, observed for an average of 9.5 years"
  units: "Bank-year observations for local banks and their boards"
  n: "1,307 banks; 9,957 bank-year observations after lagged independent variables"

evidence:
  sample_n: "Longitudinal analyses of 1,307 banks between 1996 and 2012"
  sample_country: "local banks in the United States"
  sample_industry: "local bank, or community bank"
  sample_time_period: "between 1996 and 2012"
...
- Mediators: Financial trouble indicators are examined in additional analyses as possible mediating outcomes.
...
The findings caution against assuming that more domain experts always make boards more effective. For local banks, regulators, founders, and investors should consider whether expert-heavy boards may be risky when the organization faces substantial decision uncertainty. The implication is not that boards should have no domain experts, but that boards may need a non-trivial number of directors whose primary expertise lies outside the focal domain.

**Limitations**
The sample is limited to local banks founded after 1996, so the observed effects may depend on organizational age, the banking context, and boards that are directly involved in strategic decision making. The 1996-2012 window includes the 2007-2008 financial crisis, although the authors report robustness checks excluding 2008 and 2009. The data do not distinguish which domain experts are more or less prone to cognitive entrenchment or overconfidence.

**Future Research**
Future research could examine whether these effects fade in older organizations or vary in unusually volatile versus stable economic environments. Additional work could study heterogeneity among experts, including whether exposure to other domains or prior volatile conditions reduces entrenchment and overconfidence. The authors also call for research on whether the findings generalize beyond banking, especially where boards are less directly involved in strategic decisions or where expert-heavy boards confer stronger legitimacy benefits.

**APA 7th Citation**
Almandoz, J., & Tilcsik, A. (2016). When experts become liabilities: Domain experts on boards and organizational failure. *Academy of Management Journal*, 59(4), 1124-1149. https://doi.org/10.5465/amj.2013.1211
