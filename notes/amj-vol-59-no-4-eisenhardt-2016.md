---
id: amj-vol-59-no-4-eisenhardt-2016
...
doi: "https://doi.org/10.5465/amj.2016.4004"
volume: 59
issue: 4
pages: "1113-1123"

source: "AMJ/vol-59-no-4"
pdf_path: "library/AMJ/vol-59-no-4/pdfs/Eisenhardt 2016 Grand Challenges and Inductive Methods Rigor without Rigor Mortis.pdf"
...
theory: ["inductive methods", "grounded theory building", "theoretical sampling"]
topics: ["methods-theory", "qualitative-methods", "theory-development", "grand-challenges"]
unit_of_analysis: "na"
level_of_theory: "na"
dependent_variable_family: "na"
methods: "Editorial commentary that develops an argument about why inductive methods are well suited to grand challenges and how qualitative researchers can preserve rigor without imposing rigid templates."
sample:
...
evidence:
  ...
  theories_overview: "grounded theory building"
  methods_overview: "Inductive methods are those approaches through"
  keywords_source: "Grand challenges require novel ideas"
---
...
- Grand-challenge affordances: Novel ideas, effective process explanations, attention to configurations and equifinality, hard-to-measure constructs, and extreme cases.
- Rigor conditions: Internal coherence and parsimony, compelling grounding in data, and rich, unexpected insights.
...
For authors, the editorial advises matching the research design, analysis, and presentation format to the focal question rather than forcing every qualitative paper into the same display or process template. For reviewers and editors, it implies that strong inductive work should be judged by theory quality, data grounding, and insight, not by ritual compliance with favored qualitative artifacts.
