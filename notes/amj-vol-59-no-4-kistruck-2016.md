---
id: amj-vol-59-no-4-kistruck-2016
...
doi: "https://doi.org/10.5465/amj.2014.0201"
volume: 59
issue: 4
pages: "1174-1198"

source: "AMJ/vol-59-no-4"
pdf_path: "library/AMJ/vol-59-no-4/pdfs/Kistruck 2016 Cooperation vs. Competition Alternative Goal Structures for Motivating Groups in a Resource Scarce Environment.pdf"
...
theory: ["social interdependence theory", "goal interdependence theory", "institutional economics"]
topics: ["social-entrepreneurship-impact", "base-of-pyramid", "organizational-behavior-hrm", "economics-public-policy"]
unit_of_analysis: "organization"
level_of_theory: "meso"
dependent_variable_family: "social"
methods: "Quasi-experimental field experiment assigning rural Sri Lankan school-construction communities to competition or cooperation conditions, analyzed with hierarchical linear models and Monte Carlo indirect-effect tests, followed by qualitative focus groups coded in NVivo."
sample:
  industry: "Base-of-the-pyramid school construction and community infrastructure projects"
  country: "Sri Lanka"
  time_period: "2012 calendar year field experiment; follow-up qualitative study shortly after completion"
  units: "Rural communities and school construction committees participating in Edubuild school projects"
  n: "44 communities; 452 construction committee members in the baseline survey; approximately 200 focus-group participants"

# Mandatory evidence anchors (v2 - Layer 1 faithfulness audit).
evidence:
  sample_n: "44 communities within rural Sri Lanka"
  sample_country: "Sri Lanka for the 2012 calendar year"
  sample_industry: "school construction projects"
  sample_time_period: "for the 2012 calendar year"
...
- Moderating condition: Inter-group familiarity moderates the effect of goal structure on motivation and the indirect path from goal structure to goal attainment.
...
Organizations working in resource-scarce communities can use inter-group competition to encourage participation in collective infrastructure projects, especially when communities must allocate scarce labor, materials, and time across competing demands. Cooperation may still be useful when paired groups are unfamiliar and can exchange valuable knowledge, but managers should not assume that familiarity automatically creates shared responsibility.

**Limitations**
The authors selected an extreme resource-scarce context rather than experimentally varying resource scarcity, so the exact point at which cooperation and competition reverse in motivational effectiveness remains untested. The inter-group familiarity measure used a single item, and the goal-attainment measure did not capture other performance outcomes such as task quality, creativity, sabotage, or animosity. The authors also note possible omitted variables despite random assignment and controls, and the competition manipulation may have been dampened by allowing a tied prize split.

**Future Research**
Future research should test where along the resource-scarcity continuum the motivational advantage of competitive versus cooperative goal structures changes. It should also measure inter-group familiarity more richly, examine whether changing resource conditions alter intrinsic and extrinsic motivation over time, and study additional performance consequences of competition and cooperation, including task quality, creativity, destructive competition, and omitted-variable concerns in matched-pair designs.

**APA 7th Citation**
Kistruck, G. M., Lount, R. B., Jr., Smith, B. R., Bergman, B. J., Jr., & Moss, T. W. (2016). Cooperation vs. competition: Alternative goal structures for motivating groups in a resource scarce environment. *Academy of Management Journal*, 59(4), 1174-1198. https://doi.org/10.5465/amj.2014.0201
