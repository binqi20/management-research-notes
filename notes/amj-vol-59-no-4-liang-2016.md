...
doi: "https://doi.org/10.5465/amj.2014.0651"
volume: 59
issue: 4
pages: "1385-1406"

source: "AMJ/vol-59-no-4"
pdf_path: "library/AMJ/vol-59-no-4/pdfs/Liang 2016 Why Are Abusive Supervisors Abusive A Dual-system Self-control Model.pdf"
...
theory: ["dual-system theoretical framework of self-control", "victimization perspective of abusive supervision", "hostile attribution bias", "mindfulness"]
topics: ["organizational-behavior-hrm", "leadership-behavior", "emotions-at-work", "experiments"]
unit_of_analysis: "multi-level"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Three-study design combining two experimental-causal-chain studies with full-time supervisors and a multi-wave, multi-source field study of supervisor-subordinate teams analyzed with multilevel structural equation modeling."
sample:
  industry: "Study 1 and Study 2 used full-time supervisors recruited from Amazon's Mechanical Turk; Study 3 used full-time employees at four financial institutions in China."
  country: "Study 1 and the hostile-attribution pretest sampled supervisors living in the United States or Canada; Study 3 was conducted in China."
  time_period: "Study 3 collected supervisor and subordinate data at two time points separated by one week; calendar dates are not reported."
  units: "Full-time supervisors, subordinates, and supervisor-subordinate teams."
  n: "Study 1 analyzed 92 full-time supervisors; Study 2 analyzed 101 full-time supervisors; Study 3 analyzed complete data from 50 supervisors and 206 subordinates."

evidence:
  sample_n: "50 supervisors and 206 subordinates"
  sample_country: "working at four financial institutions in China"
  sample_industry: "four financial institutions in China"
  sample_time_period: "at two time points"
...
- Mediators: Supervisor hostility toward the subordinate mediates the relationship between subordinate performance and abusive supervision.
...
The authors argue that organizations may reduce abusive supervision by reducing hostile interpretations and by strengthening supervisors' awareness and acceptance of hostile feelings. They suggest cognitive reappraisal training and mindfulness training as interventions that may prevent hostility from becoming abusive behavior. They also note a selection implication: organizations may benefit from supervisors and subordinates who are better able to regulate behavior.

**Limitations**
The authors acknowledge that they controlled for trickle-down antecedents but did not compare their self-control model against all possible antecedents of abusive supervision. They also note that abusive supervision may sometimes be effortful and intentional rather than a self-control failure, although their own evidence did not support that interpretation. The experimental studies used visualizations and intentions, while the field study strengthened external validity but did not support every main-effect hypothesis.

**Future Research**
Future research could compare the self-control model with other frameworks for abusive-supervision antecedents beyond trickle-down accounts. The authors call for work relaxing the assumption that abusive supervision is always self-control failure by examining supervisory beliefs about the instrumental value of aggression. They also suggest using the dual-system framework to identify additional moderators of workplace victimization, including reappraisal tendencies, negative relationship histories, self-control capacity, sleep deprivation, and social norms.
