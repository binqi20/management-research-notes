---
id: amj-vol-59-no-5-boivie-2016
...
doi: "https://doi.org/10.5465/amj.2014.0840"
volume: 59
issue: 5
pages: "1681-1706"

source: "AMJ/vol-59-no-5"
pdf_path: "library/AMJ/vol-59-no-5/pdfs/Boivie 2016 Come Aboard! Exploring the Effects of Directorships in the Executive Labor Market.pdf"
...
theory: ["certification theory", "signaling theory", "human capital", "social capital"]
topics: ["board-of-directors", "ceo-leadership", "executive-compensation", "signaling-theory"]
unit_of_analysis: "individual"
level_of_theory: "cross-level"
dependent_variable_family: "financial"
methods: "Empirical quantitative study using BoardEx, Execucomp, Compustat, institutional ownership, and Fama-French industry data. The authors use propensity score matching to construct treated and counterfactual executive groups, then test promotion outcomes with event history and multinomial logit models, title promotion with multiple-failure event history analysis, and pay with OLS regression."
sample:
  industry: "Large, publicly traded companies."
  country: "United States."
  time_period: "1996 to 2012."
  units: "Top executives of large, publicly traded companies, comparing first-time directors with matched non-director counterfactual executives."
  n: "2,104 top executives, consisting of 1,052 executives with first-time directorships and 1,052 matched counterfactual executives without directorships."

evidence:
  sample_n: "longitudinal sample of 2,104 top executives"
  sample_country: "companies in the United States"
  sample_industry: "large, publicly traded companies"
  sample_time_period: "period 1996 to 2012"
...
- Mediators: No formal mediator is estimated; the theorized channels are third-party certification and gains in human and social capital.
...
For boards and firms evaluating CEO succession candidates, first-time directorships may operate as visible signals of executive quality, but the paper also implies that such signals should be interpreted alongside other evidence of capability. For executives, board service can carry career returns beyond director fees, including promotion opportunities and higher compensation. For governance practice, these career incentives may shape directors' motivation to seek and retain board seats.

**Limitations**
The authors state that endogeneity cannot be ruled out completely, although they use propensity score matching to reduce this threat. They also note that board appointments and subsequent CEO promotions may partly reflect stages of one promotion process, despite the study's lag structure and controls for COO and president positions. The analysis is also limited by the lack of large-scale data on executive search firms.

**Future Research**
Future research could examine whether multiple board appointments and director-network centrality affect subsequent executive promotion. The authors also suggest studying whether prior director experience shapes the decisions and performance of executives after they become CEOs. Additional work could examine how executive search firms influence promotion to CEO and longer-term career trajectories.

**APA 7th Citation**
Boivie, S., Graffin, S. D., Oliver, A. G., & Withers, M. C. (2016). Come aboard! Exploring the effects of directorships in the executive labor market. *Academy of Management Journal*, 59(5), 1681-1706. https://doi.org/10.5465/amj.2014.0840
