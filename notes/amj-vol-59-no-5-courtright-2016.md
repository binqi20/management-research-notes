---
id: amj-vol-59-no-5-courtright-2016
...
doi: "https://doi.org/10.5465/amj.2013.1009"
volume: 59
issue: 5
pages: "1630-1652"

source: "AMJ/vol-59-no-5"
pdf_path: "library/AMJ/vol-59-no-5/pdfs/Courtright 2016 My Family Made Me Do It A Cross-Domain, Self-Regulatory Perspective on Antecedents to Abusive Supervision.pdf"
...
theory: ["resource drain theory", "self-regulatory resource depletion", "ego depletion"]
topics: ["organizational-behavior-hrm", "leadership-behavior", "work-arrangements", "quantitative-methods"]
unit_of_analysis: "multi-level"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Two empirical quantitative studies: a lagged survey study of supervisors and subordinates in a Fortune 500 financial services organization, followed by an experience sampling study of supervisors across multiple organizations and industries. Analyses include moderated regression in Study 1 and random coefficient modeling for nested daily data in Study 2."
sample:
  industry: "Study 1 used a Fortune 500 financial services organization; Study 2 used a multi-organization, multi-industry supervisor sample representing 22 industries."
  country: "Study 1 sampled the firm's North America offices; Study 2's country is not reported in paper."
  time_period: "Study 1 collected three survey waves across roughly four months; Study 2 collected 10 consecutive daily surveys during a two-week work period. Calendar dates are not reported in paper."
  units: "Supervisors, subordinates, and supervisor-day observations."
  n: "Study 1: 134 supervisors and 580 subordinates after exclusions; Study 2: 92 supervisors retained, with 857 daily observations."

evidence:
  sample_n: "final sample size of 92 supervisors"
  sample_country: "North America offices"
  sample_industry: "financial services"
  sample_time_period: "10 consecutive daily surveys"
...
- Mediators: Ego depletion, tested directly in Study 2 as the mechanism linking daily FWC to daily abusive supervision.
...
The paper suggests that organizations seeking to reduce abusive supervision should address supervisors' family-work dynamics, not only select leaders or improve immediate workplace conditions. Flexible work arrangements may help reduce FWC, and policies or climates that make sanctions for abusive behavior salient may weaken the translation of ego depletion into abuse. The authors also point to recovery of self-regulatory resources, including leisure and sleep-related interventions, as a possible prevention route.

**Limitations**
The authors note that Study 2's daily variables were collected from the same source at the same time of day, so same-source bias may have affected the mediation results despite supplementary lagged analyses. Study 2's multi-industry sample helped generalizability but did not allow industry or macro-level moderation tests. The authors also acknowledge possible overlap between cognitive ego depletion and emotional mood-spillover processes, even though they controlled for daily hostility.

**Future Research**
Future research could examine how abusive supervision and its antecedent relationships vary across industries and other macro-level conditions. The authors call for more precise work separating cognitive ego-depletion processes from emotional reactions to FWC. They also suggest studying antecedents of FWC and using more extensive panel and event studies to test chronic effects of life events and FWC on abusive supervision.
