...
doi: "https://doi.org/10.5465/amj.2014.0425"
volume: 59
issue: 5
pages: "1801-1822"

source: "AMJ/vol-59-no-5"
pdf_path: "library/AMJ/vol-59-no-5/pdfs/Sun 2016 The Dark Side of Board Political Capital Enabling Blockholder Rent Appropriation.pdf"
...
theory: ["resource dependence theory", "agency theory", "principal-principal agency theory", "corporate political strategy"]
topics: ["corporate-governance", "board-of-directors", "corporate-political-activity", "agency-theory"]
unit_of_analysis: "firm"
level_of_theory: "cross-level"
dependent_variable_family: "financial"
methods: "Empirical quantitative panel study of Chinese listed manufacturing firms. The authors use fixed-effects hierarchical regressions with Heckman two-stage correction, supplemented by Poisson regressions on regulatory sanctions and additional debt-financing and firm-performance analyses."
sample:
  industry: "Manufacturing firms listed on the Shanghai Stock Exchange or Shenzhen Stock Exchange."
  country: "China."
  time_period: "2008-2011."
  units: "Chinese listed manufacturing firms and their directors."
  n: "1,046 firms, 2,854 firm-year observations, and 32,174 individual directors."

evidence:
  sample_n: "2,854 firm-year observations"
  sample_country: "Chinese listed firms"
  sample_industry: "all Chinese manufacturing"
  sample_time_period: "over the period 2008–2011"
...
- Mediators: No formal mediator is estimated. The theorized channels are reduced legal/regulatory discipline and greater access to alternative financing that weakens equity-market discipline.
...
The findings imply that outside investors should not treat board political connections as uniformly valuable. Investors should evaluate whether the firm's ownership, industry regulation, and institutional environment make political capital more likely to facilitate blockholder appropriation. For policymakers, the paper suggests that political directors are not inherently harmful, but their value-creation role depends on institutions that prevent one party from using political ties against other stakeholders.

**Limitations**
The authors caution that the findings are based on Chinese listed companies and should be generalized carefully to contexts without concentrated ownership, passive boards, and weak institutions. ORECTA captures a transparent form of tunneling but may miss less visible forms of rent appropriation. The study also uses a dichotomous additive measure of board political capital and lacks detailed director-level data on bureaucratic rank and years of service.

**Future Research**
Future research could test whether board capital also worsens managerial agency problems in widely held public corporations. It could examine whether the same mechanism operates in developed economies with more robust institutions and stronger board independence. Further work could collect more granular director-level political-capital data, develop measures of less visible appropriation, and trace longer-term co-movement between equity and debt financing.
