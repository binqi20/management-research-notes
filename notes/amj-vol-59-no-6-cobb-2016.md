...
doi: "https://doi.org/10.5465/amj.2015.0715"
volume: 59
issue: 6
pages: "2103-2131"

source: "AMJ/vol-59-no-6"
pdf_path: "library/AMJ/vol-59-no-6/pdfs/Cobb 2016 Funding Financial Inclusion Institutional Logics and the Contextual Contingency of Funding for Microfinance Organizations.pdf"
...
theory: ["institutional logics perspective (Thornton, Ocasio, & Lounsbury, 2012)", "environmental uncertainty and organizational response (Audia, Locke, & Smith, 2000; Davis, Eisenhardt, & Bingham, 2009)"]
topics: ["social-enterprise", "impact-investing", "institutional-theory", "development-economics"]
unit_of_analysis: "organization"
level_of_theory: "cross-level"
dependent_variable_family: "financial"
methods: "Empirical quantitative cross-sectional time-series study using proprietary MIX raw MFO funding data, ICRG country uncertainty measures, factor scores for MFO size, financial performance, and transparency, and OLS regression models with country- and year-fixed effects. Interviews with 34 industry informants support the theory-building around commercial and public funder logics."
sample:
  industry: "Global microfinance funding; loans from commercial and public funders to microfinance organizations."
  country: "92 countries"
  time_period: "2004 to 2012"
  units: "MFO-year observations for microfinance organizations receiving traceable loans from commercial and public funders."
  n: "891 MFOs in 92 countries that borrowed from 1,490 funders; regression models report 1,746 MFO-year observations."

evidence:
  sample_n: "891 MFOs in 92 countries"
  sample_country: "891 MFOs in 92 countries"
  sample_industry: "database of microfinance funding"
  sample_time_period: "from 2004 to 2012"
...
The findings imply that smaller MFOs may struggle to finance loan portfolios precisely when country uncertainty increases and microfinance need intensifies. MFOs may improve funding access by growing, forming alliances, or improving transparency before uncertainty rises. Public funders and policymakers may need loan guarantees, reserve capital pools, or subsidized insurance mechanisms to keep capital flowing to smaller, socially oriented MFOs during volatile periods.

**Limitations**
The analysis is limited to debt financing and does not include grants, equity, capacity-building funds, or regulatory-infrastructure funding. The study also cannot fully assess how national regulatory capacity conditions the effects of funding on microfinance outcomes. Finally, although the authors rule out several alternatives, they cannot directly observe whether external audiences interpret public funders' shifts toward larger MFOs as mission drift.

**Future Research**
Future studies should examine other funding instruments, including grants and equity, as more data become available. Research should also study how regulatory capacity, safeguards against overborrowing, and competition among MFOs shape whether additional funding improves or harms microfinance sectors. The authors also suggest studying conflicts among internal and external audiences over how the same institutional logic should be interpreted, especially in organizations pursuing both financial and social aims.

**APA 7th Citation**
Cobb, J. A., Wry, T., & Zhao, E. Y. (2016). Funding financial inclusion: Institutional logics and the contextual contingency of funding for microfinance organizations. *Academy of Management Journal*, 59(6), 2103-2131. https://doi.org/10.5465/amj.2015.0715
