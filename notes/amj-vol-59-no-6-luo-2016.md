...
doi: "https://doi.org/10.5465/amj.2015.0693"
volume: 59
issue: 6
pages: "2045-2068"

source: "AMJ/vol-59-no-6"
pdf_path: "library/AMJ/vol-59-no-6/pdfs/Luo 2016 Mobilization in the Internet Age Internet Activism and Corporate Response.pdf"
...
theory: ["social movement theory", "social comparison theory", "political opportunity structure"]
topics: ["corporate-social-responsibility", "stakeholder-engagement", "quantitative-methods", "china"]
unit_of_analysis: "firm"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Event history analysis of corporate donation timing, using Gompertz models with firm-clustered robust standard errors and propensity score weighting; supplementary OLS and Heckman models examine total donation amount."
sample:
  industry: "Large publicly listed Chinese firms across industries, with state-controlled and private firms plus publicly listed financial institutions."
  country: "China"
  time_period: "Daily donation spells from the May 12, 2008 Sichuan earthquake through June 30, 2008."
  units: "Large publicly listed Chinese firms"
  n: "613 firms"

evidence:
  sample_n: "613 large publicly listed Chinese firms"
  sample_country: "China’s listed companies"
  sample_industry: "613 large publicly listed Chinese firms"
  sample_time_period: "Most donations were made before June 30"
...
- Mediators: Not directly modeled as mediators; the theoretical process centers on public attention, social comparison, and corporate public image threat.
...
The findings imply that firms operating in tightly controlled societies may still face rapid public pressure through online activism, especially when their public image is vulnerable. Managers should monitor online comparisons and recognize that delayed or inadequate responses to social demands can intensify reputational exposure.

**Limitations**
The authors note that they did not directly capture the interactive features of online media, such as comments or article forwarding, which may mean the study underestimates Internet activism's impact. They also study one form of Internet activism in one post-earthquake setting, limiting direct evidence about other online tactics and contexts.

**Future Research**
Future research can examine how newer online tactics, including microblogging and social-networked communication through platforms such as Twitter, Weibo, and WeChat, affect corporate responses. The paper also points to the need to study Internet activism's constraints, including government monitoring, false information, and the limits of online mobilization in tightly controlled settings.
