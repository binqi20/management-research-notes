---
id: amj-vol-59-no-6-martin-2016
...
doi: "https://doi.org/10.5465/amj.2015.0680"
volume: 59
issue: 6
pages: "2157-2177"

source: "AMJ/vol-59-no-6"
pdf_path: "library/AMJ/vol-59-no-6/pdfs/Martin 2016 Echoes of Our Upbringing How Growing Up Wealthy or Poor Relates to Narcissism, Leader Behavior, and Leader Effectiveness.pdf"
...
theory: ["social learning theory (Bandura, 1977)", "self-sufficiency hypothesis (Miller et al., 2015; Piff, 2014; Vohs et al., 2006)", "integrative trait-behavioral model of leadership effectiveness (DeRue et al., 2011)"]
topics: ["organizational-behavior-hrm", "leadership-behavior", "quantitative-methods"]
unit_of_analysis: "individual"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Empirical quantitative study using a multisource, cross-sectional survey of active-duty U.S. Army leaders and followers, archival USMA application data for parental income and demographics, confirmatory factor analysis, structural equation modeling with maximum likelihood estimation, and bootstrap confidence intervals for serial mediation."
sample:
  industry: "Military leadership in the United States Army."
  country: "United States Army; respondents served in the United States and abroad."
  time_period: "Online survey active for 12 weeks; exact calendar dates not reported in paper."
  units: "USMA alumni in leadership roles and nominated followers."
  n: "229 USMA alumni leaders with complete focal and control-variable data, drawn from 579 self-assessment respondents; 444 nominated followers responded."

evidence:
  sample_n: "229 of the 579 (40%)"
  sample_country: "active duty soldiers in the United States Army"
  sample_industry: "active duty soldiers in the United States Army"
  sample_time_period: "the online survey active for 12 weeks"
...
- Mediators: Adult narcissism and leaders’ engagement in relational-, task-, and change-oriented leadership behaviors.
...
The authors argue that organizations may benefit from attenuating the entitlement and grandiosity that can accompany some wealthy backgrounds, for example by eliciting compassion or valuing humility. They caution against selecting leaders on parental income, emphasizing instead that the negative pathways through narcissism and subsequent leadership behaviors should be mitigated.

**Limitations**
The authors note that the cross-sectional survey design prevents conclusive causal claims for some reported relationships. They also acknowledge possible omitted variables, same-source ratings for leadership behaviors and effectiveness outcomes, few participants in the highest income bracket, and the use of one strong-norm organization where ongoing leader-follower relationships may make narcissism especially costly.

**Future Research**
Future research should examine other pathways through which parental income relates to leadership, including potentially positive effects through educational opportunities, competencies, or technical abilities. Scholars could also study other leadership behaviors such as servant leadership, test the model in organizations with weaker norms or less frequent interaction, and assess whether narcissistic leaders fare differently in contexts where they are fast-tracked or where self-oriented behavior is viewed more favorably.
