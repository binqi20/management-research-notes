...
doi: "https://doi.org/10.5465/amj.2015.0730"
volume: 59
issue: 6
pages: "2232-2255"

source: "AMJ/vol-59-no-6"
pdf_path: "library/AMJ/vol-59-no-6/pdfs/Olsen 2016 Coordinated Exploration for Grand Challenges The Role of Advocacy Groups in Search Consortia.pdf"
...
theory: ["stakeholder theory", "coordinated exploration in organizational search", "signaling theory", "organizational legitimacy"]
topics: ["stakeholder-engagement", "innovation-management", "stakeholder-theory", "grand-challenges"]
unit_of_analysis: "organization"
level_of_theory: "meso"
dependent_variable_family: "financial"
methods: "Empirical quantitative study of FP7 grant applications. The paper combines content analysis of call texts, a first-stage probit selection model for advocacy group inclusion, fixed-effects OLS models for evaluation scores, an inverse Mills ratio correction, instrumental-variable logic, and robustness checks including alternative measures and coarsened exact matching."
sample:
  industry: "European FP7 grand challenge funding calls across themes including food and agriculture, health, ICT, nanotechnologies, energy, environment, transportation, security, and socio-economic and humanities-related issues."
  country: "European Commission Seventh Framework Program context, with participating organizations across multiple regions."
  time_period: "2007-2013"
  units: "Search consortia submitting FP7 Cooperation applications and the European Commission calls to which they applied"
  n: "35,249 consortia applying to solve 2,349 grand challenge problems; 1,284 consortia included at least one advocacy group."

# Mandatory evidence anchors (v2 - Layer 1 faithfulness audit).
evidence:
  sample_n: "We observe a total of 35,249 consortia"
  sample_country: "Seventh Framework Program"
  sample_industry: "food and agriculture, health"
  sample_time_period: "FP7 ran from 2007 to 2013"
...
- Mediators: Not directly estimated; the theory distinguishes improved search for stakeholder-acceptable solutions and legitimacy signals to evaluators.
...
For governments and foundations, the findings imply that the wording of grand challenge calls can influence whether consortia include advocacy groups and stakeholder concerns. For firms, universities, and other consortium members, cultivating credible advocacy group relationships may improve proposal quality and evaluation, especially when the consortium is technologically dispersed or inexperienced. For advocacy groups, participation can be a way to shape solutions to grand challenges in line with stakeholder interests.
