...
doi: "https://doi.org/10.5465/amj.2014.0847"
volume: 60
issue: 1
pages: "321-344"

source: "AMJ/vol-60-no-1"
pdf_path: "library/AMJ/vol-60-no-1/pdfs/Luo 2017 Whose Call to Answer Institutional Complexity and Firms’ CSR Reporting.pdf"
...
theory: ["institutional complexity", "institutional theory", "decoupling"]
topics: ["corporate-social-responsibility", "esg-disclosure", "institutional-theory", "china"]
unit_of_analysis: "firm"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Empirical quantitative study of Chinese publicly listed firms from 2008-2011. The authors use discrete-time repeated event history analysis for CSR report issuance, random-effects linear regression with a Heckman selection correction for report quality, and random-effects logistic regression for a decoupling response, with standard errors clustered by province."
sample:
  industry: "Public firms listed on the Shenzhen or Shanghai Stock Exchanges across CSRC industry categories."
  country: "China."
  time_period: "2008-2011."
  units: "Firm-year observations of Chinese publicly listed firms."
  n: "6,709 firm-year observations across four years, pertaining to 2,028 unique firms; 584 firms issued at least one CSR report, corresponding to 1,779 report observations."

evidence:
  sample_n: "6,709 firm-year observations"
  sample_country: "publicly listed firms in China"
  sample_industry: "Shenzhen or Shanghai Stock"
  sample_time_period: "between 2008 and 2011"
...
- Mediators: Not directly measured; the theorized channels are scrutiny from institutional constituencies, legitimacy and resource dependence, attention to provincial GDP priorities, and reduced substantive commitment to CSR.
...
The findings suggest that central CSR reporting guidelines may trigger quick disclosure without substantive implementation when local governments reward different objectives. This matters for interpreting CSR reports because early issuance can coexist with lower report quality under conflicting state pressures. The study therefore points to the practical importance of attending to both the speed and quality of CSR reporting, rather than treating adoption alone as evidence of substantive CSR engagement.

**Limitations**
The study does not fully examine mature-market influences such as exports or foreign investment experience, even though such exposure may shape CSR reporting. The China setting is theoretically useful because of strong state involvement and weak market institutions, but this also limits generalizability to mature markets where local governments are not similarly focused on short-term GDP growth. The relatively short observation window limits the ability to identify the effects of changes in provincial priorities over time.

**Future Research**
Future research could compare how conflicting state pressures shape CSR disclosure in other institutional settings, especially mature markets and other emerging economies. Studies with longer panels or policy changes in local government priorities could better establish the causal impact of institutional conflict on firm responses. The authors also call for research on how mature-market influences, such as export activity and foreign-investment experience, affect CSR reporting.
