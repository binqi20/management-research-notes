...
The paper presents its findings as implications for research on regulation, organizational responses to institutional complexity, decoupling, and practice diffusion rather than as practitioner guidance. Under conflicting government pressures, organizations exposed to magnified institutional pressures may adopt a practice early yet implement it less substantively, so adoption speed alone is not evidence of substantive implementation. The framework helps predict unintended consequences of regulation when fragmented state actors impose competing pressures.
...
**Future Research**
Future research should compare how institutional pressures and logics take on different meanings and trigger different organizational responses in other settings. Studies covering longer time periods and changes in provincial-government priorities could better establish the causal impact of institutional conflict on firm responses.
