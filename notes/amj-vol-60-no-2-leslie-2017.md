---
id: amj-vol-60-no-2-leslie-2017
...
doi: "https://doi.org/10.5465/amj.2015.0195"
volume: 60
issue: 2
pages: "402-432"

source: "AMJ/vol-60-no-2"
pdf_path: "library/AMJ/vol-60-no-2/pdfs/Leslie 2017 Why and When Does the Gender Gap Reverse Diversity Goals and the Pay Premium for High Potential Women.pdf"
...
theory: ["supply and demand", "strategic human resource management theory", "meso paradigm in organizational research"]
topics: ["diversity-equity-inclusion", "gender-in-organizations", "workplace-discrimination", "quantitative-methods"]
unit_of_analysis: "multi-level"
level_of_theory: "cross-level"
dependent_variable_family: "financial"
methods: "Four empirical quantitative studies: a field study of employees in a Fortune 500 organization, a laboratory experiment with graduate business students, a field study of top executives in S&P 1500 organizations, and a laboratory experiment with working adults. Analyses use hierarchical regression, clustered standard errors, median regression, experimental manipulation checks, and moderated mediation tests."
sample:
  industry: "Study 1 examined employees at the corporate headquarters of a Fortune 500 organization; Studies 2 and 4 used a simulated consumer products company; Study 3 examined S&P 1500 organizations in consumer goods, consumer services, and manufacturing."
  country: "The paper does not report one common sample country across all four studies."
  time_period: "Study 1 conducted a survey over three weeks; Study 3 used executive pay data from 1992 through 2006; Studies 2 and 4 do not report calendar dates."
  units: "Individual employees, graduate business students evaluating a target employee, top executives, and working adults evaluating a target employee."
  n: "Study 1: 1,311 employees; Study 2: 270 graduate business students; Study 3: 35,602 observations for 8,968 executives in 2,320 organizations; Study 4: 303 Mechanical Turk participants."

evidence:
  sample_n: "sample of 1,311 employees"
  sample_country: "Not reported in paper"
  sample_industry: "Fortune 500 organization"
  sample_time_period: "from 1992 through 2006"
...
- Mediators: Diversity value perceptions; in Study 4, retention perceptions further link diversity value to rewards.
...
The findings imply that pay-equity audits should not only compare men and women overall, because an aggregate female penalty can mask a high-potential female premium. Organizations should examine pay by potential rating and job level, and should clarify whether diversity value is an appropriate factor in reward decisions. The paper also warns that diversity goals may generate legal, fairness, or backlash concerns if they unintentionally produce gender-based pay disparities.

**Limitations**
The authors note that the field studies have strong external validity but do not permit causal inference or direct tests of all individual-level mechanisms. The laboratory studies provide internal validity and all-else-equal comparisons but rely on simulated tasks and include only some participants with management experience. Study 3 uses industry as a proxy for diversity-goal strength, so other industry differences may also contribute to the observed premium.

**Future Research**
Future research could examine other sources of contextual variation, including whether legal, social, moral, or business-case motives for diversity goals change the size of the female premium. The authors also suggest extending the theory to other groups targeted by diversity initiatives, including racial minorities.
