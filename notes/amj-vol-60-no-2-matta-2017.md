...
doi: "https://doi.org/10.5465/amj.2014.0455"
volume: 60
issue: 2
pages: "743-770"

source: "AMJ/vol-60-no-2"
pdf_path: "library/AMJ/vol-60-no-2/pdfs/Matta 2017 Is Consistently Unfair Better than Sporadically Fair An Investigation of Justice Variability and Stress.pdf"
...
theory: ["uncertainty management theory", "fairness heuristic theory", "organizational justice theory"]
topics: ["organizational-behavior-hrm", "employee-wellbeing", "emotions-at-work", "leadership-behavior"]
unit_of_analysis: "multi-level"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Two-study empirical quantitative design. Study 1 is a randomized laboratory experiment manipulating consistently fair, consistently unfair, and variably fair supervisor feedback during a stock-price simulation, with heart rate as a physiological stress indicator and ANOVA/planned comparisons. Study 2 is a multilevel experience-sampling field study of employee-supervisor dyads over three weeks, analyzed with multilevel path analysis in Mplus and bootstrapped indirect effects."
sample:
  industry: "Study 1 uses junior- and senior-level undergraduate management students in a stock-price simulation. Study 2 includes full-time working adults from tourism, education, real estate/construction, government, health care, technology, retail/distribution, financial, and manufacturing industries."
  country: "Not reported in paper"
  time_period: "Study 1 is a single laboratory session; Study 2 collects one daily survey each working day over a three-week period."
  units: "Study 1 participants and Study 2 employee-supervisor dyads with daily observations nested within employees."
  n: "Study 1 reports an effective sample of 161 participants after quality checks; Study 2 includes 97 employees providing 995 daily surveys."

# Mandatory evidence anchors (v2 - Layer 1 faithfulness audit).
evidence:
  sample_n: "97 employees who provided 995 daily surveys"
  sample_country: "Not reported in paper"
  sample_industry: "(9.3%), education (7.2%), real estate/construction"
  sample_time_period: "a three-week period"
...
- Mediators: Daily stress mediating effects of justice variability and uncertainty on job dissatisfaction and emotional exhaustion; justice variability mediating supervisor self-control and stress.
...
The paper suggests that organizations should focus not only on increasing average fairness but also on helping supervisors deliver fair treatment consistently. Justice training that produces short-term spikes followed by decline may introduce harmful variability unless embedded in longer-term leadership development and feedback systems. The supervisor self-control findings also imply that selection and promotion systems may benefit from assessing traits linked to consistent, disciplined treatment of employees.

**Limitations**
The authors note that Study 1 measured physiological stress but not perceptual stress, while Study 2 measured perceptual stress but not physiological stress. Study 1 manipulated interpersonal justice rules even though the theory centers on overall fairness, and its design did not fully cross average justice and justice variability. Study 2 relied on self-reported Level 1 variables and used overall fairness rather than dimension-specific justice measures.

**Future Research**
Future research could examine which employees are most affected by justice variability, such as those low in trust propensity. The authors also call for work on whether justice variability matters differently at high versus low average justice, how temporal factors such as self-control depletion across the day shape variability, and how justice variability differs from other within-person variability constructs that have a more internal locus.
