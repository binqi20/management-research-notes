...
doi: "https://doi.org/10.5465/amj.2015.0584"
volume: 60
issue: 3
pages: "1138-1163"

source: "AMJ/vol-60-no-3"
pdf_path: "library/AMJ/vol-60-no-3/pdfs/Ridge 2017 Beyond Lobbying Expenditures How Lobbying Breadth and Political Connectedness Affect Firm Outcomes.pdf"
...
theory: ["resource allocation", "political connections"]
topics: ["corporate-political-activity", "lobbying-regulation", "quantitative-methods", "longitudinal"]
unit_of_analysis: "firm"
level_of_theory: "macro"
dependent_variable_family: "financial"
methods: "Empirical quantitative panel study of S&P 500 firms, using random-effects Tobit models for left-censored government-contract outcomes and two-step Arellano-Bond dynamic panel GMM models for firm performance, with controls for lobbying expenditures, PAC and 527 contributions, firm characteristics, industry lobbying, regulation, and tax exposure."
sample:
  industry: "S&P 500 firms across multiple industries."
  country: "United States."
  time_period: "2004-2009, with 2003 data collected to reduce lagged-instrument losses."
  units: "Firm-year observations."
  n: "2,180 observations in government-contract models."

evidence:
  sample_n: "Observations                       2180"
  sample_country: "The sample consists of U.S. firms listed in the S&P"
  sample_industry: "sample of firms across multiple industries"
  sample_time_period: "these firms from 2004 to 2009"
...
- Mediators: Not directly modeled.
...
The findings imply that managers should not evaluate lobbying strategy only by total expenditure. Firms may benefit from broadening lobbying targets and building political connectedness, but spreading lobbying too widely can dilute attention and reduce marginal returns. Managers therefore need to balance breadth with focus and consider whether political connections are being applied where they can still generate influence.

**Limitations**
The authors identify data availability as a central limitation: government contracts and firm performance are observable across industries, but large-scale regulatory and legislative outcomes are harder to measure. The study is also bounded by the U.S. political system, whose transparency and institutional structure may differ from other countries and democratic contexts. Other contextual interactions, such as particular lobbyists' effectiveness or the difference between in-house and contracted lobbying, remain outside the tested model.

**Future Research**
Future research can examine industry-, regulation-, or legislation-specific settings where more detailed policy-process outcomes are observable. The authors also call for studies outside the United States to test whether lobbying breadth and connectedness operate similarly in other political systems. Additional work could investigate when the tipping point in lobbying breadth occurs and whether in-house versus contracted lobbyists change the degree of diminishing returns.

**APA 7th Citation**
Ridge, J. W., Ingram, A., & Hill, A. D. (2017). Beyond lobbying expenditures: How lobbying breadth and political connectedness affect firm outcomes. *Academy of Management Journal*, 60(3), 1138-1163. https://doi.org/10.5465/amj.2015.0584
