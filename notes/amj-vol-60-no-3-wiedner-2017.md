---
id: amj-vol-60-no-3-wiedner-2017
...
doi: "https://doi.org/10.5465/amj.2014.0474"
volume: 60
issue: 3
pages: "823-854"

source: "AMJ/vol-60-no-3"
pdf_path: "library/AMJ/vol-60-no-3/pdfs/Wiedner 2017 The Emergence of Change in Unexpected Places Resourcing across Organizational Practices in Strategic Change.pdf"
...
theory: ["resourcing perspective", "practice-based theories", "resource dependence theory", "Bourdieu's relational framework"]
topics: ["strategy-innovation", "practice-theory", "qualitative-methods", "theory-development"]
unit_of_analysis: "organization"
level_of_theory: "meso"
dependent_variable_family: "social"
methods: "Longitudinal, in-depth qualitative case study of strategic change in health care contract management within the National Health Service in England. The authors compare three contract-management practices using observation, interviews, shadowing, archival documents, event-history construction, coding in NVivo, and process analysis."
sample:
  industry: "Public health care services and health care contract management."
  country: "England."
  time_period: "The focal analysis covers July 2009 to March 2013; interviews extended from July 2010 to October 2014."
  units: "MgmtAgency contract-management practices, MgmtAgency managers, health care provider representatives, GP representatives, and related public health care organizations."
  n: "More than 700 hours of observation, 66 semi-structured interviews, and over 20 GB of archival data."

evidence:
  sample_n: "interviews, and over 20 GB of archival data"
  sample_country: "National Health Service in England"
  sample_industry: "contracting health care services"
  sample_time_period: "July 2009 to March 2013"
...
- Practice-level comparison: Hospital contract management received substantial resources and attention but remained hard to change because GP representatives were reluctant to challenge hospital doctors and faced high coordination costs. Community care contract management drew strong GP and manager interest, creating willingness to challenge but also high scrutiny and negotiation costs. Mental health contract management was deprioritized and lightly resourced, but this lack of interest created space for Kate, GP representatives, and mental health clinicians to coordinate changes quickly.
...
For managers, the study cautions that allocating more resources and formal authority to a priority area does not guarantee change if coordination costs, scrutiny, or deference to powerful incumbents block action. It also suggests that apparently neglected areas may contain usable space for experimentation when actors can recognize and use the lower-interference conditions. Change leaders should therefore monitor unintended cross-practice effects rather than evaluating only the formally targeted practice.
