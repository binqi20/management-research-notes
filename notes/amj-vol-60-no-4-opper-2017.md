...
doi: "https://doi.org/10.5465/amj.2015.0355"
volume: 60
issue: 4
pages: "1504-1530"

source: "AMJ/vol-60-no-4"
pdf_path: "library/AMJ/vol-60-no-4/pdfs/Opper 2017 Risk Aversion and Guanxi Activities A Behavioral Analysis of CEOs in China.pdf"
...
theory: ["investment theory", "behavioral strategy", "upper echelon theories", "guanxi theory"]
topics: ["competitive-strategy", "upper-echelons-theory", "quantitative-methods", "china"]
unit_of_analysis: "multi-level"
level_of_theory: "cross-level"
dependent_variable_family: "financial"
methods: "Empirical quantitative study combining a manager and firm survey with incentivized behavioral tasks using multiple price list formats for risk elicitation. The analysis uses OLS regression models, split-sample contingency tests by firm age and market orientation, and interaction models linking guanxi, risk aversion, and firm performance."
sample:
  industry: "Private manufacturing companies in textiles, ordinary machinery, automobile and vehicle parts, pharmaceuticals, and electronic and communication appliances."
  country: "China."
  time_period: "The focal analysis uses the 2009 CEO survey; the broader panel survey was first conducted in 2006 and repeated at three-year intervals, with 2012 data used for robustness checks."
  units: "CEOs and private manufacturing firms in seven municipalities of China's extended Yangzi Delta region."
  n: "345 valid CEOs in the risk-aversion task analysis."

evidence:
  sample_n: "345 randomly sampled CEOs"
  sample_country: "Yangzi Delta region in China"
  sample_industry: "private manufacturing companies"
  sample_time_period: "panel survey conducted in 2009"
...
**Future Research**
Future research could test similar behavioral mechanisms in less developed Chinese regions, rural areas, and more institutionally varied settings. The authors also call for research on whether risk-averse CEOs select exchange partners more carefully and monitor guanxi more closely. Broader applications could examine whether CEO risk aversion affects other long-horizon relational strategies such as R&D partnerships, internationalization, lobbying, alliances, and mergers and acquisitions.
