---
id: amj-vol-60-no-4-waldman-2017
...
doi: "https://doi.org/10.5465/amj.2014.0644"
volume: 60
issue: 4
pages: "1285-1306"

source: "AMJ/vol-60-no-4"
pdf_path: "library/AMJ/vol-60-no-4/pdfs/Waldman 2017 A Neurological and Ideological Perspective of Ethical Leadership.pdf"
...
theory: ["moral self theory", "ethics position theory", "organizational cognitive neuroscience perspective", "trait approach to leadership"]
topics: ["business-ethics", "ethical-decision-making", "leadership-behavior", "quantitative-methods"]
unit_of_analysis: "individual"
level_of_theory: "micro"
dependent_variable_family: "social"
methods: "Empirical quantitative study combining leader self-reports, peer/subordinate ratings, and qEEG measurement. The authors test regression, moderated mediation, and bootstrapped indirect-effect models linking right-hemisphere default mode network connectivity, ethical ideology, and rated ethical leadership."
sample:
  industry: "Business and military sectors: mid- and senior-level U.S. Army officers, executive MBA students, and private-sector managers from varied occupations."
  country: "United States."
  time_period: "Not reported in paper."
  units: "Individual leaders rated by peers or subordinates."
  n: "104 leaders: 27 military officers, 29 EMBA participants, and 48 private-sector managers; models use 94-104 observations depending on variables."

evidence:
  sample_n: "The sample included 104 leaders"
  sample_country: "Southwestern U.S."
  sample_industry: "private-sector managers"
...
- Mediators: Leader relativism as one dimension of ethical ideology.
...
The authors suggest that organizations may eventually use neurological signatures, alongside conventional leadership development tools, to understand and develop ethical leadership, while warning that neurofeedback is not a "magic bullet." They also argue that leader selection and development should attend to ethical ideology: subjectivism appears misaligned with ethical leadership, whereas a consistent but pragmatic orientation appears more aligned. The implication is qualified because the observed ideological profile may vary across institutional and cultural contexts.
