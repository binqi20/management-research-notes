---
id: amj-vol-60-no-5-ballesteros-2017
...
doi: "https://doi.org/10.5465/amj.2015.0765"
volume: 60
issue: 5
pages: "1682-1708"

source: "AMJ/vol-60-no-5"
pdf_path: "library/AMJ/vol-60-no-5/pdfs/Ballesteros 2017 Masters of Disasters An Empirical Analysis of How Societies Benefit from Corporate Disaster Aid.pdf"
...
theory: ["dynamic capabilities literature (Teece, 2007; Teece, Pisano, & Shuen, 1997)", "corporate social responsibility literature"]
topics: ["corporate-social-responsibility", "csr-strategy", "dynamic-capabilities", "public-policy"]
unit_of_analysis: "country"
level_of_theory: "macro"
dependent_variable_family: "social"
methods: "Empirical quantitative study using a proprietary global data set of sudden natural disasters and reported disaster-aid donations from 2003 to 2013; the main analysis uses the synthetic control method with placebo tests, plus regression and matching robustness checks."
sample:
  industry: "Disaster relief and recovery involving corporate, government, and multilateral aid donations after sudden natural disasters."
  country: "Worldwide sample covering 129 countries."
  time_period: "2003 to 2013."
  units: "Disaster-nation events for aid-speed analyses and country-year disasters for recovery analyses."
  n: "2,182 discrete disaster-nation events for aid-speed analyses and 464 country-year disasters for recovery analyses."

# Mandatory evidence anchors (v2 - Layer 1 faithfulness audit).
evidence:
  sample_n: "2,182 discrete disaster-nation events"
  sample_country: "129 countries"
  sample_industry: "disaster relief and recovery"
  sample_time_period: "2003 to 2013"
...
For managers, the findings imply that disaster-response CSR is more likely to create social value when decisions are delegated to local affiliates and when aid draws on the firm's core expertise rather than generic giving. For policymakers and disaster-relief organizations, the paper implies that locally active firms can be important partners in relief and recovery, but coordination with traditional aid providers remains necessary because corporate aid is not a panacea for all disaster-response needs.

**Limitations**
The paper cautions that disaster relief is only one context in which stakeholders ask firms to play a larger social role, so generalizing to other CSR issues requires care. The analysis focuses on aggregate corporate aid and national outcomes, not on the performance or motives of individual firms. The authors also note unresolved tensions around in-kind donations, which may arrive quickly and support recovery but can be difficult to repurpose as needs evolve.

**Future Research**
The paper calls for future studies to examine whether dynamic capabilities help predict the social effectiveness of CSR in other contexts and for different social issues. It also suggests studying coordination and cooperation among firms in collective CSR initiatives, the variable influence of distinct types of relief resources, differences across industries, and how corporate aid interacts with other disaster-response stakeholders.

**APA 7th Citation**
Ballesteros, L., Useem, M., & Wry, T. (2017). Masters of disasters? An empirical analysis of how societies benefit from corporate disaster aid. *Academy of Management Journal*, 60(5), 1682-1708. https://doi.org/10.5465/amj.2015.0765
