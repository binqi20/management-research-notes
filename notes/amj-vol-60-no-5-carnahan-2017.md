---
id: amj-vol-60-no-5-carnahan-2017
...
doi: "https://doi.org/10.5465/amj.2015.0032"
volume: 60
issue: 5
pages: "1932-1962"

source: "AMJ/vol-60-no-5"
pdf_path: "library/AMJ/vol-60-no-5/pdfs/Carnahan 2017 When Does Corporate Social Responsibility Reduce Employee Turnover Evidence from Attorneys Before and After 911.pdf"
...
theory: ["meaningfulness at work (Pratt & Ashforth, 2003; Rosso, Dekas, & Wrzesniewski, 2010)", "unfolding model of employee turnover (Lee & Mitchell, 1994)", "CSR as insurance / risk management (Godfrey, 2005)"]
topics: ["corporate-social-responsibility", "csr-strategy", "meaningful-work", "longitudinal"]
unit_of_analysis: "multi-level"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Empirical quantitative longitudinal employee-employer linked study of attorney-firm-year observations in large U.S. law firms, using logit and multinomial logit competing-risk models, with robustness checks including firm fixed effects, partner-only samples, coarsened exact matching, alternative pro bono measures, and firm-level models."
sample:
  industry: "Large U.S. corporate law firms in the AmLaw 200; CSR is measured through pro bono legal services."
  country: "United States"
  time_period: "Martindale data cover 1999 to 2011; the main nonshock tests use attorneys employed by AmLaw 200 firms from 1999 to 2010."
  units: "Attorney-firm-year observations, attorneys, law firms, and mutually exclusive job-change destinations."
  n: "Main analytic models use 524,407 attorney-year observations; the 9/11 sample uses 196,263 attorney-year observations."

evidence:
  sample_n: "n attorney-year obs                                       524407"
  sample_country: "limited to firms and lawyers in the United States"
  sample_industry: "large corporate law firms"
  sample_time_period: "from 1999 to 2011"
...
- Mediators: Meaningfulness at work is the theorized mechanism, but the paper does not directly measure an individual-level mediator.
...
Managers should not expect CSR investments to reduce all forms of turnover equally. CSR activities such as pro bono work may be most useful for retaining employees who are searching for more meaningful work, especially after shocks that make life purpose more salient. At the same time, the findings warn that CSR can have retention downsides: it may make employees more marketable to competitors or push away employees who do not value a pro-social firm culture.

**Limitations**
The authors caution against drawing strong causal conclusions because pro bono activities are not randomly assigned across firms, the pro bono measure is imperfect, and the empirical design has limits. The study focuses on employees of large corporate law firms, a high-status but relatively low-meaningfulness professional-services setting, so generalizability to other occupations, industries, mortality shocks, and forms of CSR is uncertain. The data do not observe attorneys' individual participation in CSR activities, cannot precisely identify why employees depart, and cannot track all destinations after attorneys leave the Martindale data.

**Future Research**
The paper calls for research on when CSR enhances, fails to enhance, or increases retention, including deeper study of why higher CSR is associated with more moves to competing law firms. Future work could test the CSR-as-insurance logic in other professional-service settings, other mortality shocks, and other CSR activities, especially those that are more symbolic than substantive. Additional research could use richer data on individual CSR participation and post-exit destinations to identify the meaningfulness mechanism more directly.

**APA 7th Citation**
Carnahan, S., Kryscynski, D., & Olson, D. (2017). When does corporate social responsibility reduce employee turnover? Evidence from attorneys before and after 9/11. *Academy of Management Journal*, 60(5), 1932-1962. https://doi.org/10.5465/amj.2015.0032
