---
id: amj-vol-60-no-5-lawrence-2017
...
doi: "https://doi.org/10.5465/amj.2015.0714"
volume: 60
issue: 5
pages: "1771-1800"

source: "AMJ/vol-60-no-5"
pdf_path: "library/AMJ/vol-60-no-5/pdfs/Lawrence 2017 High-Stakes Institutional Translation Establishing North America’s First Government-sanctioned Supervised Injection Site.pdf"
...
theory: ["institutional translation", "institutional change", "emotions and institutions"]
topics: ["institutional-theory", "social-innovation", "public-policy", "qualitative-methods"]
unit_of_analysis: "multi-level"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Empirical qualitative process study of the establishment of Insite in Vancouver, using interviews, observation, documentary analysis, secondary sources, historical timeline construction, constant comparative analysis, temporal bracketing, and NVivo coding."
sample:
  industry: "Drug use, addiction, harm reduction, and supervised injection-site organizing in Vancouver's Downtown Eastside."
  country: "Canada; the case is set in Vancouver."
  time_period: "Interviews were conducted between June 2004 and June 2007; the historical narrative covers the events leading to Insite's September 2003 opening."
  units: "Translations, actors, organizations, documents, public events, and material sites involved in establishing Insite."
  n: "36 interviews with 25 individuals."

# Mandatory evidence anchors (v2 - Layer 1 faithfulness audit).
evidence:
  sample_n: "conducted 36 interviews with 25 individuals"
  sample_country: "Vancouver, Canada"
  sample_industry: "drug use and addiction in the Downtown Eastside"
  sample_time_period: "Between June 2004 and June 2007"
...
- Practices: Government reports, conferences, newspaper accounts, public protests, demonstration sites, illegal sites, Four Pillars framing, mayoral politics, and the final sanctioned Insite facility.
- Emergent outcomes: A contested foreign practice becomes a locally embedded practice supported by health authorities, city officials, nonprofit actors, police cooperation, researchers, and drug-user advocates.
...
For communities facing serious social problems, the paper implies that importing a contentious response may depend on many smaller translations rather than one decisive intervention. Practitioners should engage in translations of the idea and also enable others to translate it through different texts, spaces, demonstrations, routines, and relationships. The study also suggests that collective emotionality and collective reflexivity can help actors who do not usually collaborate tie their work together around a common cause.

**Limitations**
Not reported in paper

**Future Research**
The paper identifies several issues for further scholarly development rather than presenting a standalone future-research section. It points to the conditions under which collective reflexivity can integrate distributed agency, the value of adding translation concepts to social movement research, and the potential role of empathy in connecting social enterprise organizations to broader social change processes.

**APA 7th Citation**
Lawrence, T. B. (2017). High-stakes institutional translation: Establishing North America’s first government-sanctioned supervised injection site. *Academy of Management Journal*, 60(5), 1771-1800. https://doi.org/10.5465/amj.2015.0714
