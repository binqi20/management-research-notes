---
id: amj-vol-60-no-5-schaumberg-2017
...
doi: "https://doi.org/10.5465/amj.2015.0018"
volume: 60
issue: 5
pages: "1859-1881"

source: "AMJ/vol-60-no-5"
pdf_path: "library/AMJ/vol-60-no-5/pdfs/Schaumberg 2017 Self-reliance A Gender Perspective on its Relationship to Communality and Leadership Evaluations.pdf"
...
theory: ["expectancy violation theory", "role congruity theory", "prescriptive and proscriptive gender stereotypes"]
topics: ["organizational-behavior-hrm", "leadership-behavior", "gender-in-organizations", "role-theory"]
unit_of_analysis: "individual"
level_of_theory: "micro"
dependent_variable_family: "social"
methods: "Four-study quantitative design combining 360-degree leadership evaluations of young managers with three experiments manipulating or varying leader gender and agentic trait, analyzed with hierarchical linear regression, between-subjects ANOVA, and moderated mediation."
sample:
  industry: "Study 1 involved young managers across a range of industries; Studies 2-4 used political, financial-services, and Silicon Valley technology leader contexts rather than an industry sample."
  country: "United States."
  time_period: "Not reported in paper"
  units: "Young managers or MBA students, MTurk participants, and evaluated male or female political and executive leaders."
  n: "Study 1 regression analyses report N = 234; Study 2 reports 123 participants; Study 3 reports 521 participants; Study 4 reports 533 participants after exclusions and listwise deletion."

evidence:
  sample_n: "the sample size was 123 for all analyses"
  sample_country: "from the United States"
  sample_industry: "financial services firm"
...
- Mediators: Perceived communality.
...
The findings imply that female leaders' displays of agency are not uniformly penalized and that self-reliance can improve evaluations when it is not read as low communality. For evaluators and organizations, the results suggest that leadership assessments may depend on trait-specific gender inferences rather than on agency as a single broad category.

**Limitations**
The authors note that the experimental effects in Studies 2-4 may not fully generalize to evaluations of one's own leader, especially in longstanding relationships where beliefs about a leader's communality may diverge from gender stereotypes. They also state that the paper focuses on broad leadership evaluations, which may mask more specific judgments about leadership styles or behaviors. The evidence for a male advantage in dominance was weaker than role congruity theory and expectancy violation theory would predict, possibly because the experiments focused on high-status leaders.

**Future Research**
The paper calls for research on whether self-reliance shapes evaluations of one's own leader differently from evaluations of unfamiliar or vignette-based leaders. It suggests examining more specific evaluations of self-reliant men and women, such as perceived transformational, transactional, or servant leadership styles. It also proposes studying whether other prescriptive masculine traits, such as being analytical, rational, or logical, can produce similar female advantages and whether knowledge of such advantages affects women's efficacy in pursuing leadership roles.

**APA 7th Citation**
Schaumberg, R. L., & Flynn, F. J. (2017). Self-reliance: A gender perspective on its relationship to communality and leadership evaluations. *Academy of Management Journal*, 60(5), 1859-1881. https://doi.org/10.5465/amj.2015.0018
