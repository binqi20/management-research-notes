---
id: amj-vol-60-no-5-venkatesh-2017
...
doi: "https://doi.org/10.5465/amj.2015.0849"
volume: 60
issue: 5
pages: "1709-1740"

source: "AMJ/vol-60-no-5"
pdf_path: "library/AMJ/vol-60-no-5/pdfs/Venkatesh 2017 Networks, Technology, and Entrepreneurship A Field Quasi-experiment among Women in Rural India.pdf"
...
theory: ["social networks theory", "socio-structural view of ICT use", "temporal theory"]
topics: ["entrepreneurship", "technology-adoption", "gender-in-organizations", "india"]
unit_of_analysis: "individual"
level_of_theory: "cross-level"
dependent_variable_family: "financial"
methods: "Seven-year field quasi-experiment in 20 rural Indian villages. Ten villages received staffed Internet-enabled ICT kiosks and ten geographically proximal villages served as controls. The study used annual structured interviews, kiosk-use logs, government filings where available, social-network centrality measures, and generalized estimating equations with repeated person-year observations to predict ICT use, entrepreneurial activity, and entrepreneurial profit."
sample:
  industry: "Rural village entrepreneurship and microbusiness activity, including restaurants, handicrafts, farming support, food delivery, and milk delivery."
  country: "India."
  time_period: "Seven annual waves over a seven-year field quasi-experiment."
  units: "Adult women in 20 rural villages; person-year observations for longitudinal models; women-founded businesses for profit analyses."
  n: "Sampling frames covered 8,330 adult women in intervention villages and 8,600 adult women in control villages, with reported sample sizes of 6,662 intervention and 6,801 control respondents across annual waves. The main tables report n = 94,241 for most person-year analyses and n = 1,400 for profit."

evidence:
  sample_n: "Notes: n 5 94,241 for all except profit, where n 5 1,400."
  sample_country: "20 villages in rural India"
  sample_industry: "spectrum to include restaurants, handicrafts"
  sample_time_period: "over the seven years"
...
- Mediators: Not reported in paper; the study tests direct and moderated relationships rather than a mediation model.
...
The findings suggest that relatively modest ICT access, when staffed and made accessible to women, can support entrepreneurial activity and profit in rural India. Policy makers and development organizations should not treat ICT infrastructure as sufficient by itself; staffed kiosks, women-accessible locations, women-only training, and local facilitation matter because literacy, mobility, and gender norms shape whether women can use ICT resources. The results also imply that interventions should account for social networks, because family and community ties can amplify ICT benefits whereas ties to male local officials may constrain women's entrepreneurial activity.

**Limitations**
The authors state that they are unable to disentangle the complex mechanisms underlying the cultural constraints associated with women's ties to men in power. They also treat the design of the ICT intervention as a black box, so the study does not identify which specific design features of the kiosks drive the observed effects. Generalizability is bounded by the rural Indian setting; the authors note that other countries and contexts may involve similar and different constraints, such as different governmental regulations or gender-related institutions.

**Future Research**
The paper calls for detailed qualitative work on how women with ties to men in power can overcome sociocultural barriers to new business initiation. It also recommends studying other interventions and complementary investments, including government programs, NGO initiatives, media activities, mobile technologies, and scalable ICT designs. Future research should examine other network types such as advice, friendship, and hindrance networks, multiplex ties across family and power networks, and cross-context studies of women's empowerment and grand challenges in settings beyond rural India.
