---
id: amj-vol-61-no-1-miron-spektor-2018
...
doi: "https://doi.org/10.5465/amj.2016.0594"
volume: 61
issue: 1
pages: "26-45"

source: "AMJ/vol-61-no-1"
pdf_path: "library/AMJ/vol-61-no-1/pdfs/Miron-Spektor 2017 Microfoundations of Organizational Paradox The Problem Is How We Think about the Problem.pdf"
...
theory: ["organizational paradox theory", "paradox mindset"]
topics: ["organizational-behavior-hrm", "innovation-management", "theory-development"]
unit_of_analysis: "individual"
level_of_theory: "micro"
dependent_variable_family: "financial"
methods: "Multi-study scale development and validation, followed by a quantitative field test using employee surveys, supervisor-rated outcomes, qualitative coding of open-ended tension examples, CFA, regression, and PROCESS moderated mediation."
sample:
  industry: "Large consumer products company with electronic, industrial, pharmaceutical, medical, and fabric departments; additional scale-development samples included employees and students."
  country: "Study 1 samples from the U.S., UK, Israel, and China; Study 2 tested the model in a large firm in the U.S."
  time_period: "Not reported in paper"
  units: "Individuals: employees, students, product specialists, and supervisor-rated product specialists."
  n: "Study 1 used eight samples ranging from 80 to 300 participants; Study 2 surveyed 135 product specialists, with supervisor ratings for 91."

evidence:
  sample_n: "fabric (N 5 135, Female 5 18%, Mean age 5 43.5"
  sample_country: "samples from the U.S., UK, Israel, and China"
  sample_industry: "consumer products"
...
- Mediators: Experiencing tensions mediates the indirect relationship between resource scarcity and the two job outcomes.
...
The findings suggest that recognizing tensions is not enough; employees and leaders also need a mindset that enables acceptance, comfort, and productive engagement with contradictions. The paradox mindset scale offers a way for leaders and practitioners to assess their approaches to tensions and begin building awareness around how those approaches affect job outcomes.

**Limitations**
The model test is cross-sectional, so longitudinal or experimental designs would provide stronger evidence of causality and reduce common-method concerns. The outcomes rely on supervisors' evaluations, the field test focuses on product specialists in one U.S. firm, and the study examines limited time and finances as the main sources of learning and performing tensions.

**Future Research**
Future work should test the model across cultures, contexts, and other kinds of tensions, including organizing and identity tensions. The paper also calls for research on cognitive, behavioral, organizational, cultural, developmental, and training-related factors that may strengthen or weaken paradox mindset.
