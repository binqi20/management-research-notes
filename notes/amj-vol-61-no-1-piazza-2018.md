---
id: amj-vol-61-no-1-piazza-2018
...
doi: "https://doi.org/10.5465/amj.2015.1325"
volume: 61
issue: 1
pages: "165-190"

source: "AMJ/vol-61-no-1"
pdf_path: "library/AMJ/vol-61-no-1/pdfs/Piazza 2017 When the Dust Settles The Consequences of Scandals for Organizational Competition.pdf"
...
theory: ["scandal theory", "social identity theory", "substitution effect", "church-sect strictness theory"]
topics: ["business-ethics", "unethical-behavior", "competitive-strategy", "social-identity-theory"]
unit_of_analysis: "organization"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Empirical quantitative study using county-level church membership data, Catholic sex-abuse scandal publicity, and denomination strictness/similarity measures; the authors estimate Arellano-Bond dynamic panel models for Catholic membership and generalized estimating equation models for non-Catholic denomination-county dyads, with robustness checks using survey and alternative similarity/strictness measures."
sample:
  industry: "Christian denominations, including the Catholic Church and 16 other Christian denominations."
  country: "United States."
  time_period: "1971 to 2000."
  units: "Counties and denomination-county dyads observed across church membership waves."
  n: "Main reported models include 5,660 Catholic county observations and 169,390 non-Catholic denomination-county observations, with 50,149 denomination-county dyads in the full GEE model."

evidence:
  sample_n: "Number of denomination–county dyads                      50,249"
  sample_country: "United States between 1971 and 2000"
  sample_industry: "17 Christian denominations"
  sample_time_period: "between 1971 and 2000"
...
Scandal-stricken organizations should treat member or customer loss as a competitive risk, not only a reputational problem, and should act to reduce identity threat and leakage of key constituencies. Competitors can benefit by credibly emphasizing close substitute offerings, categorical distance from the scandal-stricken actor, and stricter standards of conduct.

**Limitations**
The setting links similarity and strictness through a unidimensional church-sect continuum, which may not hold in other industries or fields. Churches also differ from market-based organizations because members often have deep identity ties and because norm enforcement may be especially salient in religious organizations. The data are aggregate, so the authors cannot directly observe individual coping, exit, or switching mechanisms.

**Future Research**
Future research could test whether the competitive effects of scandals vary by organization type, constituency type, and category structure. It could also examine the durability of contamination versus substitution effects, whether stricter organizations sustain advantages after scandals, and when field-level scandals produce broader evaluative backlash. Additional work could investigate scope conditions such as information asymmetry, internal control, network closure, emotional solidarity, and collective liability.
