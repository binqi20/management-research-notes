...
doi: "https://doi.org/10.5465/amj.2016.0094"
volume: 61
issue: 1
pages: "324-347"

source: "AMJ/vol-61-no-1"
pdf_path: "library/AMJ/vol-61-no-1/pdfs/Yu 2017 Introducing Team Mindfulness and Considering its Safeguard Role Against Conflict Transformation and Social Undermining.pdf"
...
theory: ["mindfulness theory", "team conflict theory", "conflict expression theory"]
topics: ["organizational-behavior-hrm", "teams-collaboration", "conflict-resolution", "quantitative-methods"]
unit_of_analysis: "team"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Three multi-wave quantitative field studies: Study 1 develops and validates a team mindfulness scale; Studies 2 and 3 use survey data from teams and multilevel structural equation modeling to test moderated mediation in team conflict processes."
sample:
  industry: "MBA project teams and healthcare organization teams."
  country: "United States and China."
  time_period: "Multi-wave survey designs; Study 2 follows MBA teams across a semester, and Study 3 uses two-month lags between survey waves."
  units: "Teams and individual team members."
  n: "Study 2: 198 individuals in 44 teams; Study 3: 292 individuals in 48 teams."

evidence:
  sample_n: "study 2, for individual-level, n 5 198; for group-level, n 5 44. In study 3, for individual-level, n 5 292; for group-level, n 5 48"
  sample_country: "in a Chinese healthcare organization"
  sample_industry: "project teams in an MBA program"
  sample_time_period: "Results from three multi-wave field studies validate"
...
- Mediators: Relationship conflict mediates the relationship between task conflict and individual social undermining.
...
The findings suggest that managers and team leaders may benefit from team-level mindfulness training, meditation, or activities designed to support present-focused attention and nonjudgmental processing in team interactions. Such interventions may help teams prevent task disagreements from becoming relationship conflict and reduce the interpersonal costs of conflict.

**Limitations**
The authors note that the studies use single-source data and correlational designs, so causal ordering should be interpreted cautiously. They also caution that team mindfulness and relationship conflict were measured at the same time in the field studies, and that future research should directly measure conflict expression, oppositional intensity, and negative emotions rather than infer these mechanisms from conflict measures.

**Future Research**
Future research should use experimental or stronger longitudinal designs to test causal order and the development of team mindfulness. The authors also call for work on how team mindfulness relates to performance, how individual and team mindfulness jointly shape outcomes, and how team mindfulness relates to affective emergent states such as cohesion or psychological safety.
