...
doi: "https://doi.org/10.5465/amj.2015.1061"
volume: 61
issue: 2
pages: "661-684"

source: "AMJ/vol-61-no-2"
pdf_path: "library/AMJ/vol-61-no-2/pdfs/Foulk 2018 Heavy Is the Head that Wears the Crown An Actor-centric Approach to Daily Psychological Power, Abusive Leader Behavior, and Perceived Incivility.pdf"
...
theory: ["social distance theory of power (Magee & Smith, 2013)", "consent-based theories of power (Hindess, 1996; Overbeck, 2010)", "self-determination theory (Deci & Ryan, 2000)"]
topics: ["organizational-behavior-hrm", "leadership-behavior", "employee-wellbeing", "experiments"]
unit_of_analysis: "individual"
level_of_theory: "micro"
dependent_variable_family: "social"
methods: "Experimental experience sampling study of professional and managerial employees, with a one-time background survey and three daily surveys across 10 consecutive workdays; psychological power was manipulated daily, and hypotheses were tested with multilevel path analyses in Mplus 7.3."
sample:
  industry: "Professional and managerial employees across varied industries, including medicine, engineering, education, and banking."
  country: "United States."
  time_period: "Three-workweek study period, including 10 consecutive workdays of daily surveys."
  units: "Professional and managerial employees enrolled in executive MBA courses; day-level observations nested within individuals."
  n: "108 participants and 832 day-level data points."

evidence:
  sample_n: "we received a total of 832"
  sample_country: "a large southeastern university in the United States"
  sample_industry: "medicine, engineering"
  sample_time_period: "for 10 consecutive workdays"
...
- Mediators: Perceived incivility mediating power's effect on abusive behavior; abusive behavior carrying the power effect to reduced relaxation and reduced need fulfillment, with perceived incivility carrying the power effect to reduced need fulfillment.
...
The findings imply that organizations should treat psychological power as a fluctuating daily state rather than only a formal role attribute. Accountability structures, honest feedback from someone higher up in the organization, and leader awareness of power's corrupting effects may help reduce abusive behavior. The paper also suggests that placing more agreeable people in powerful roles and providing relaxation or mindfulness opportunities may reduce harm to both followers and leaders.

**Limitations**
The study relies on self-reported mediators and outcomes, which raises common method and source-bias concerns even though the independent variable was manipulated and measures were time separated. The power manipulation may also have activated competitiveness, so its effects may not generalize to every form of psychological power. The authors note that abusive leadership had a low base rate in the sample and that they did not measure follower reactions to leaders' power, incivility perceptions, or abusive behavior.

**Future Research**
Future research should replicate the findings with multiple data sources and examine whether power also affects negative or positive behaviors at home. The authors call for work disentangling psychological power from competitiveness and comparing psychological with structural power. They also encourage studies of follower reactions, power loss, longer time spans, and other moderators such as prosocial motivation, self-monitoring, narcissism, and self-concern.
