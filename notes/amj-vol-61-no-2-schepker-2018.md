---
id: amj-vol-61-no-2-schepker-2018
...
doi: "https://doi.org/10.5465/amj.2016.0071"
volume: 61
issue: 2
pages: "523-552"

source: "AMJ/vol-61-no-2"
pdf_path: "library/AMJ/vol-61-no-2/pdfs/Schepker 2018 Planning for Future Leadership Procedural Rationality, Formalized Succession Processes, and CEO Influence in CEO Succession Planning.pdf"
...
theory: ["procedural rationality in decision-making theory", "boards as information-processing groups", "agency and power theories"]
topics: ["governance-leadership", "corporate-governance", "board-of-directors", "ceo-leadership"]
unit_of_analysis: "firm"
level_of_theory: "meso"
dependent_variable_family: "social"
methods: "Empirical mixed-methods study that used qualitative interviews and meetings to develop theory, then tested hypotheses with CHRO surveys, archival financial and governance data, random coefficient models, logistic random coefficient models, and supplemental endogeneity analyses."
sample:
  industry: "Large U.S.-based public companies across six SIC-based industry categories, with 71% belonging to the Fortune 500."
  country: "United States."
  time_period: "Survey administrations occurred between April and June in 2013, 2014, and 2015; archival financial and governance data came from the year preceding each survey."
  units: "Firm-year observations, companies, CHRO survey respondents, qualitative CHRO interviews and meetings, CEOs, board members, and directors involved in CEO succession planning."
  n: "355 firm-year observations from 218 companies; qualitative grounding from nine CHRO interviews, meetings with 40 CHROs, one retired CEO, one current CEO, one board member, and interviews with 22 directors."

evidence:
  sample_n: "355 firm-year observations of 218 large organizations"
  sample_country: "U.S.-based public companies with complete"
  sample_industry: "six industry categories"
  sample_time_period: "between April and June for three years (2013–2015)"
...
The findings suggest that boards should actively institutionalize CEO succession processes rather than relying on informal CEO-centered knowledge. Directors can improve succession readiness by defining future CEO role requirements, identifying candidates against those requirements, and developing candidates before a transition becomes urgent. The study also implies that boards and CEOs still need collaboration, because boards remain dependent on management for candid information about internal talent.

**Limitations**
The study uses data from large U.S.-based organizations, so succession planning may operate differently in smaller firms or in other national governance systems. The results concern ongoing, friendly succession planning rather than unexpected, contested, or forced CEO transitions. The measures also do not assess the quality of the formalized processes, and common-method concerns and reciprocal causation remain possible despite the authors' robustness checks.

**Future Research**
Future research could examine when CEO influence operates as stewardship rather than agency-driven interference, and how CEOs positively help boards interpret succession information. The paper also calls for work on CHROs, external consultants, board committees, and the distinct phases of succession planning, from defining roles through transition. Additional research should study how processes change for unexpected succession events, known succession timelines, smaller firms, and non-U.S. governance settings.
