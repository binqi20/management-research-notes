---
id: amj-vol-61-no-3-eckardt-2018
...
doi: "https://doi.org/10.5465/amj.2016.0601"
volume: 61
issue: 3
pages: "919-944"

source: "AMJ/vol-61-no-3"
pdf_path: "library/AMJ/vol-61-no-3/pdfs/Eckardt 2018 An Examination of the Firm-level Performance Impact of Cluster Hiring in Knowledge-intensive Firms.pdf"
...
theory: ["strategic human capital", "signaling theory", "group dynamics"]
topics: ["hr-practices", "social-capital-theory", "strategy-innovation", "quantitative-methods"]
unit_of_analysis: "firm"
level_of_theory: "meso"
dependent_variable_family: "financial"
methods: "Archival empirical quantitative study of large domestic U.S. law firms using OLS regression for main effects and moderated hierarchical regression for interaction effects."
sample:
  industry: "Large domestic U.S. law firms from The American Lawyer top 200 list that hired two or more lateral partners in 2010."
  country: "United States."
  time_period: "Cluster-hire and firm data for 2010, with change in profit per partner measured between 2010 and 2011 and prior-year change measured between 2009 and 2010."
  units: "Law firms; cluster hires of lateral partners."
  n: "112 law firms."
...
evidence:
  sample_n: "cluster hires in 112 domestic U.S. law firms"
  sample_country: "domestic U.S. law firms"
  sample_industry: "domestic U.S. law firms"
  sample_time_period: "the United States for the year 2010"
...
Knowledge-intensive firms should not treat cluster hiring as uniformly beneficial. The findings imply that cluster hires are more likely to improve profitability when they add concentrated expertise in areas where the firm has little existing strategic human capital and when they involve low co-mobility. Firms should be cautious about acqui-hiring or team lift-outs that bring high co-mobility because these moves may create integration and appropriation costs.

**Limitations**
The authors identify the single-industry context as a limitation: the study uses law firms, which are a prototypical knowledge-intensive setting but may have industry-specific features. They also note the cross-sectional nature of the data, which limits insight into whether the relationships change over time. The study therefore cannot show the longer-term temporal dynamics of cluster hiring or interventions that might reduce the negative effects of co-mobility.

**Future Research**
The authors call for research that tests the findings in other industry contexts and examines contextual moderators of cluster hiring's value-generating ability. They suggest that network perspectives could examine novelty and integration, group-dynamics work could identify ways to reduce intergroup bias, and human capital complementarities could explain how firms capture more value from cluster hires. They also encourage longitudinal designs that can assess longer-term effects and interventions around co-mobility.
