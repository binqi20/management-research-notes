...
doi: "https://doi.org/10.5465/amj.2015.0534"
volume: 61
issue: 3
pages: "826-856"

source: "AMJ/vol-61-no-3"
pdf_path: "library/AMJ/vol-61-no-3/pdfs/Eury 2018 The Past is Not Dead Legacy Identification and Alumni Ambivalence in the Wake of the Sandusky Scandal at Penn State.pdf"
...
theory: ["social identity theory", "organizational identification theory", "legacy identification", "ambivalent identification"]
topics: ["organizational-behavior-hrm", "organizational-identity", "social-identity-theory", "qualitative-methods"]
unit_of_analysis: "individual"
level_of_theory: "micro"
dependent_variable_family: "social"
methods: "Grounded theory study of Penn State alumni responses to the Sandusky scandal, using purposeful and theoretical sampling, NVivo-supported grounded coding, constant comparison, focused and axial coding, co-occurrence analysis, alumni surveys, and alumni magazine letters as supplementary evidence."
sample:
  industry: "Higher education; Penn State as a large, multi-campus university and alumni association context."
  country: "Not reported in paper"
  time_period: "November 2011 to December 2012, with supplementary alumni opinion surveys from 2012 to 2015."
  units: "Penn State alumni communications, primarily alumni e-mails, with phone summaries, alumni opinion surveys, and alumni magazine letters as supplementary data."
  n: "25,335 communications from 14,309 alumni; the authors initially read more than 700 communications, analyzed more than 1,000 communications to stabilize the codebook, and coded approximately 500 more communications for thoroughness and representative quotations."

evidence:
  sample_n: "access to 25,335 communications from 14,309"
  sample_country: "Not reported in paper"
  sample_industry: "Penn State is a large, multi-campus university"
  sample_time_period: "November 2011 to December 2012 timeframe"
...
- Process elements: Alumni experienced a legacy identification struggle, targeted general or specific insiders and outsiders, reassessed identification, and expressed intended actions of support and/or withdrawal.
- Reassessed identification states: Unconditional identification, disidentification, reconciled identification, selective identification, and conditional identification.
- Emergent outcomes: Alumni could maintain identification by reconciling negative present events with positive past ties, selectively identifying with some parts of Penn State but not others, or making future identification conditional on organizational action.
...
**Future Research**
The paper calls for research linking legacy identification states to explicit behavior such as financial contributions, participation in organizational events, and other supportive actions. It also proposes research on antecedents and consequences of legacy identification, including investment in the organization, current social networks, critical incidents, within-person changes after identity threat, and aggregated effects on organizational change. Additional future work should examine legacy identification among former employees and current employees, across other organizations, and during more tranquil periods.

**APA 7th Citation**
Eury, J. L., Kreiner, G. E., Treviño, L. K., & Gioia, D. A. (2018). The past is not dead: Legacy identification and alumni ambivalence in the wake of the Sandusky scandal at Penn State. *Academy of Management Journal*, 61(3), 826-856. https://doi.org/10.5465/amj.2015.0534
