---
id: amj-vol-61-no-3-kotlar-2018
...
doi: "https://doi.org/10.5465/amj.2016.0256"
volume: 61
issue: 3
pages: "1073-1099"

source: "AMJ/vol-61-no-3"
pdf_path: "library/AMJ/vol-61-no-3/pdfs/Kotlar 2018 Financial Wealth, Socioemotional Wealth, and IPO Underpricing in Family Firms A Two-stage Gamble Model.pdf"
...
theory: ["behavioral agency model", "prospect theory", "socioemotional wealth", "aversion to loss realization"]
topics: ["family-business", "corporate-finance", "prospect-theory", "quantitative-methods"]
unit_of_analysis: "firm"
level_of_theory: "meso"
dependent_variable_family: "financial"
methods: "Empirical quantitative study of European IPOs using a two-step Heckman selection model, first-stage probit modeling of IPO versus acquisition, second-stage IPO underpricing regressions, clustered robust standard errors, and industry, country, and year fixed effects."
sample:
  industry: "European IPO firms across all major European stock exchanges; the sample is not restricted to a single industry and excludes investment entities, direct listings, re-admissions, market transfers, and cross-listings."
  country: "Belgium, France, Germany, Italy, the Netherlands, Portugal, and the U.K."
  time_period: "1995-2011."
  units: "IPO firms, with acquired private firms used in the selection model."
  n: "1,807 IPOs; the selection model also uses 5,508 European private firms acquired during 1995-2011."
...
evidence:
  sample_n: "sample of 1,807 IPOs"
  sample_country: "Netherlands, Portugal, and the U.K."
  sample_industry: "population of IPOs in all major"
  sample_time_period: "during 1995–2011"
...
The paper cautions family owners that SEW considerations can bias IPO pricing decisions, especially because an IPO is a rare event with little opportunity for experiential learning. It suggests that family owners can shape the pricing decision context through ownership retention, underwriter choice, and IPO timing. It also warns investors against simple family-versus-nonfamily IPO strategies because underpricing depends on more specific family-firm and market conditions.

**Limitations**
The authors note that the sample consists of relatively young IPO firms, so generalizability to older or more established family firms remains an empirical question. They also do not directly measure socioemotional wealth, instead using family involvement and generation of family leadership as proxies. Finally, the study does not examine how the financial wealth and socioemotional wealth trade-off continues after IPO through later share sales, divestitures, or long-run stock returns.

**Future Research**
The authors call for research using more direct measures of SEW and its dimensions, including how family firms trade off different SEW dimensions as well as SEW versus financial wealth. They suggest extending the two-stage gamble model to other longitudinal family-firm decisions, such as R&D, internationalization, acquisitions, exit, and divestment. They also identify post-IPO ownership evolution, subsequent sales, and long-run stock returns as promising contexts for studying temporal decision framing.
