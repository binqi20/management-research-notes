...
doi: "https://doi.org/10.5465/amj.2016.0850"
volume: 61
issue: 4
pages: "1281-1306"

source: "AMJ/vol-61-no-4"
pdf_path: "library/AMJ/vol-61-no-4/pdfs/To 2018 Going for it on Fourth Down Rivalry Increases Risk Taking, Physiological Arousal, and Promotion Focus.pdf"
...
theory: ["rivalry theory (Kilduff, Elfenbein, & Staw, 2010)", "regulatory focus theory (Crowe & Higgins, 1997; Higgins, 1997, 1998)", "behavioral activation / physiological arousal perspective on risk taking"]
topics: ["organizational-behavior-hrm", "motivation-engagement", "quantitative-methods", "experiments"]
unit_of_analysis: "multi-level"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Two-study empirical quantitative design: Study 1 analyzes NFL play-by-play archival data with rare-events logistic regressions, year and team fixed effects, and team/game/play-level controls; Study 2 uses a two-condition behavioral laboratory experiment with rival versus nonrival competition, a Columbia Card Task risk-taking measure, regulatory-focus scales, heart-rate and skin-conductance measures, and bootstrap mediation tests."
sample:
  industry: "Professional football/NFL games in Study 1; undergraduate interuniversity rivalry laboratory competition in Study 2."
  country: "United States."
  time_period: "NFL regular seasons from 2002 to 2010; Study 2 lab data collection date not reported in paper."
  units: "NFL plays/games/teams in Study 1; undergraduate participants competing against a confederate in Study 2."
  n: "Study 1: 485,684 unique plays from 2,048 NFL regular-season games, including 35,870 fourth-down decisions and 11,076 two-point decisions. Study 2: final dataset of 137 participants."

evidence:
  sample_n: "485,684 unique plays from 2,048 unique games"
  sample_country: "rivalry in the United States"
  sample_industry: "NFL regular season games"
  sample_time_period: "2002 to 2010"
...
- Mediators: Promotion focus and physiological arousal, especially heart-rate change; skin conductance increased under rivalry but did not mediate risk taking.
...
Managers should treat rivalry as a lever that can increase risk taking. Where experimentation and exploration are desirable, salient rivalries may encourage more proactive or innovative choices; where reliability and restraint matter, managers should avoid creating conditions that intensify rivalry, such as repeated public rankings among evenly matched actors.

**Limitations**
The authors state that Study 1 is correlational, so it cannot definitively establish that rivalry caused increased risk taking despite extensive controls. The research examines high-arousal, rapid decision contexts, so the effects may be weaker when decisions are made in advance or over longer periods. The empirical contexts are sports teams and university-fan competition, leaving open how the findings generalize to other organizational domains, intrateam rivalry, and different populations.

**Future Research**
Future research could examine other relational predictors of risk taking and regulatory focus, including positive ties, high-status peers, ambivalent relationships, social comparison, and trash talking. The authors also call for research on lower-arousal or colder decision contexts, spillover from exposure to rivals in one setting to behavior in another, boundary conditions around competitive position and familiarity, and rivalry in other organizational domains such as intrateam and intragroup competition.

**APA 7th Citation**
To, C., Kilduff, G. J., Ordoñez, L., & Schweitzer, M. E. (2018). Going for it on fourth down: Rivalry increases risk taking, physiological arousal, and promotion focus. *Academy of Management Journal*, 61(4), 1281-1306. https://doi.org/10.5465/amj.2016.0850
