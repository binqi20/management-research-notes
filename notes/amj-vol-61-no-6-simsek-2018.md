---
id: amj-vol-61-no-6-simsek-2018
...
doi: "https://doi.org/10.5465/amj.2018.4006"
volume: 61
issue: 6
pages: "2021-2025"

source: "AMJ/vol-61-no-6"
pdf_path: "library/AMJ/vol-61-no-6/pdfs/Simsek 2018 From the Editors—Seeing Practice Impact in New Ways.pdf"
...
methods: "Editorial essay that reframes management research practice impact through three pathways: trailing, leading, and concurrent impact."
sample:
...
# Optional for editorials; included here with verified short anchors.
evidence:
  ...
  methods_overview: "three research pathways to practice impact"
  keywords_source: "collective body of knowledge"
---

# From the Editors—Seeing Practice Impact in New Ways
...
- Leading pathway: Practice affects research before and during design, as practitioners help researchers formulate questions, identify data sources, understand context, and shape meaningful representations of findings.
...
For authors and editors, the essay implies that practice impact should be evaluated through a portfolio of research activities rather than only through direct implications attached to a single article. It encourages researchers to consider when practitioner engagement should shape research questions, design, data collection, interpretation, and dissemination. It also highlights management education as a major route through which research-informed frameworks, cases, and evidence can influence future managerial practice.

**Limitations**
Not reported in paper

**Future Research**
The editors call for studies of different impact pathways that can strengthen the field's impact balance sheet. They suggest that different concepts, tools, and techniques are needed to probe and understand that balance sheet, and that the trailing, leading, and concurrent pathways provide one framework for systematic development.

**APA 7th Citation**
Simsek, Z., Bansal, P., Shaw, J. D., Heugens, P., & Smith, W. K. (2018). From the editors: Seeing practice impact in new ways. *Academy of Management Journal*, 61(6), 2021-2025. https://doi.org/10.5465/amj.2018.4006
