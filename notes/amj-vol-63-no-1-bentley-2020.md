---
id: amj-vol-63-no-1-bentley-2020
...
doi: "https://doi.org/10.5465/amj.2018.0272"
volume: 63
issue: 1
pages: "181-204"

source: "AMJ/vol-63-no-1"
pdf_path: "library/AMJ/vol-63-no-1/pdfs/Bentley 2020 Give Them Some Slack—They’re Trying to Change! The Benefits of Excess Cash, Excess Employees, and Increased Human Capital in the Strategic Change Context.pdf"
...
theory: ["contingency theory (Burns & Stalker, 1961; Donaldson, 2001; Lawrence & Lorsch, 1967)", "resource-based view (Barney, 1991; Miller & Shamsie, 1996)", "resource management perspective (Sirmon et al., 2007; Sirmon et al., 2011)", "behavioral theory of the firm (Cyert & March, 1963)"]
topics: ["competitive-strategy", "hr-practices", "resource-based-view", "quantitative-methods"]
unit_of_analysis: "firm"
level_of_theory: "meso"
dependent_variable_family: "financial"
methods: "Empirical quantitative panel study of federally chartered U.S. commercial banks using FDIC data from 2002-2014; random-effects regression models test moderated mediation, with robustness checks using instrumental-variable/two-stage least squares models and a continuous strategic-change measure."
sample:
  industry: "Federally chartered U.S. commercial banks."
  country: "United States."
  time_period: "2002-2014."
  units: "Federally chartered banks and bank-year observations, analyzed separately for strategic-change and nonchange contexts."
  n: "6,606 federally chartered banks with at least four years of data; 60,328 observations in descriptive statistics, with 38,249 nonchange and 19,079 strategic-change observations in the main regressions."

evidence:
  sample_n: "Our sample consists of 6,606"
  sample_country: "federally chartered U.S. commercial banks"
  sample_industry: "service-intensive nature of this context"
  sample_time_period: "2014, for which at least four years"
...
- Mediators: Change in human capital investment partially mediates the complementary effect of financial slack and HR slack in the strategic-change context.
...
Managers pursuing strategic change, especially in service firms, should not automatically treat excess employees as inefficiency. HR slack can help firms maintain existing operations while developing new markets, and financial slack is most valuable when it is deliberately allocated to human capital investment that supports employees' skills, motivation, and fit with change demands.

**Limitations**
The study focuses on federally chartered U.S. commercial banks, a service-intensive context where human and financial resources are central to value creation, so generalizability to other industries and nonservice contexts remains uncertain. The dependent variable is financial performance, and the study does not directly examine nonfinancial outcomes such as service quality or labor productivity. The data also cannot pinpoint the exact timing of strategic-change decisions or explain why firms engage in strategic change or accumulate slack.

**Future Research**
Future research could test whether the findings generalize to other industries, especially settings where human capital is less central to competitive advantage. Scholars could examine more proximal nonfinancial outcomes, including service quality and labor productivity, and collect finer-grained longitudinal data on the timing of strategic-change decisions and implementation. Research could also investigate the organizational conditions that lead firms to accumulate slack and deploy it toward strategic change.
