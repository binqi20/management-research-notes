---
id: amj-vol-63-no-1-quigley-2020
...
doi: "https://doi.org/10.5465/amj.2017.0455"
volume: 63
issue: 1
pages: "155-180"

source: "AMJ/vol-63-no-1"
pdf_path: "library/AMJ/vol-63-no-1/pdfs/Quigley 2020 Unintended Consequences Information Releases and CEO Stock Option Grants.pdf"
...
theory: ["agency theory (Eisenhardt, 1989; Jensen & Meckling, 1976)", "impression management (Elsbach, Sutton, & Principe, 1998)", "equity theory (Adams, 1963)", "managerial discretion (Hambrick & Finkelstein, 1987)"]
topics: ["corporate-governance", "executive-compensation", "agency-theory", "quantitative-methods"]
unit_of_analysis: "multi-level"
level_of_theory: "cross-level"
dependent_variable_family: "financial"
methods: "Empirical quantitative event-study and panel analysis of CEO option grants at large U.S. publicly traded companies from 2009-2013. The authors combine Thompson-Reuters insider filings, Execucomp, ISS director data, Compustat, Eventus abnormal returns, and LexisNexis press releases; they use event-study CARs, LIWC press-release tenor measures, generalized estimating equations, OLS with firm-clustered robust standard errors, and structural equation modeling."
sample:
  industry: "Large U.S. publicly traded companies across GICS industries."
  country: "United States."
  time_period: "2009-2013."
  units: "CEO option grant dates, CEOs, firms, and firm press releases."
  n: "1,753 option grant dates representing 659 CEOs across 627 firms; 49,436 press releases."

evidence:
  sample_n: "sample included 1,753 option grant dates"
  sample_country: "large U.S. publicly traded companies from 2009 to"
  sample_industry: "four-digit Global Industry Classification"
  sample_time_period: "releases from 2009 to 2013"
...
- Mediators: Negative press-release activity is tested as an indirect pathway from CEO underpayment and managerial discretion to pregrant cumulative abnormal returns, with marginal and split-release nuance.
...
Boards and regulators should recognize that CEO control over information timing and tenor can affect option strike prices even after SOX curtailed backdating. The authors recommend smaller and more frequent option or stock grants, closer review or auditing of firm information releases around grant dates, and stronger information pathways between outside directors and managers beyond the CEO.

**Limitations**
The study examines CEOs of large publicly traded U.S. firms, so governance systems in other countries and smaller or less complex firms may differ. It does not directly observe whether stock price depression is conscious CEO behavior rather than a natural tendency. The study also does not test whether more negative firm releases subsequently shape media coverage.

**Future Research**
Future research could extend the analysis to countries with different regulatory environments and governance practices. Scholars could examine whether firm size and complexity change the information-asymmetry mechanism, whether the tactic spreads through board interlocks or other networks, and whether press-release tenor affects media coverage as the next step in the proposed causal chain.

**APA 7th Citation**
Quigley, T. J., Hubbard, T. D., Ward, A., & Graffin, S. D. (2020). Unintended consequences: Information releases and CEO stock option grants. *Academy of Management Journal*, 63(1), 155-180. https://doi.org/10.5465/amj.2017.0455
