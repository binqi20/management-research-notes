---
id: amj-vol-63-no-1-schubert-2020
...
doi: "https://doi.org/10.5465/amj.2017.0741"
volume: 63
issue: 1
pages: "272-294"

source: "AMJ/vol-63-no-1"
pdf_path: "library/AMJ/vol-63-no-1/pdfs/Schubert 2020 Product Innovation and Educational Diversity in Top and Middle Management Teams.pdf"
...
theory: ["problem-based view of the firm (Baer, Dirks, & Nickerson, 2013; Felin & Zenger, 2015; Nickerson & Zenger, 2004)", "upper echelons theory (Hambrick & Mason, 1984; Hambrick, 2007)", "informational variety perspective", "social identity theory"]
topics: ["innovation-management", "organizational-behavior-hrm", "upper-echelons-theory", "quantitative-methods"]
unit_of_analysis: "firm"
level_of_theory: "meso"
dependent_variable_family: "financial"
methods: "Linked employer-employee panel study using Swedish CIS, LISA, and registered firm-characteristics data; the paper estimates probit and ordered probit models with clustered standard errors."
sample:
  industry: "Firms with 10 or more employees across manufacturing, construction, and services sectors."
  country: "Sweden."
  time_period: "2004-2012."
  units: "Firm-year observations with identified top management teams and middle management teams."
  n: "486 firms and 1,873 observations for innovation engagement models; 414 firms and 1,233 observations for product innovation outcome models."

evidence:
  sample_n: "Observations                                   1,873"
  sample_country: "Sweden for the period 2004–2012"
  sample_industry: "industrial sectors, including manufacturing"
  sample_time_period: "2004, 2006, 2008, 2010, and 2012"
...
Firms should align diversity interventions with the innovation problem they face. If the issue is whether the firm engages in innovation at all, increasing educational diversity in the TMT may help strategic problem formulation. If the issue is converting innovation resources into successful and novel products, increasing educational diversity in the MMT may be more relevant.

**Limitations**
The paper notes that it does not explicitly examine how TMTs and MMTs interact across organizational levels. It also cautions that the main hypotheses should not be treated as universally true, because firm size and other contingencies may condition the diversity-innovation relationship. The authors also state that they cannot assert context-independence, although robustness checks support the results across alternative methodological choices.

**Future Research**
Future research could examine the social processes linking TMTs and MMTs, including trust, debate, and conflict across levels. Scholars could also refine the theory by studying moderators such as firm size and other organizational contingencies and by developing the proposed theory around the organizational level of the team.
