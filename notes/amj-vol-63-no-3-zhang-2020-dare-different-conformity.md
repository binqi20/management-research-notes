---
id: amj-vol-63-no-3-zhang-2020-dare-different-conformity
...
doi: "https://doi.org/10.5465/amj.2017.0412"
volume: 63
issue: 3
pages: "717-742"

source: "AMJ/vol-63-no-3"
pdf_path: "library/AMJ/vol-63-no-3/pdfs/Zhang 2020 Dare to Be Different Conformity Versus Differentiation in Corporate Social Activities of Chinese Firms and Market Responses.pdf"
...
theory: ["optimal distinctiveness", "strategic balance perspective", "institutional perspective on CSR", "strategic perspective on CSR"]
topics: ["csr-strategy", "corporate-social-responsibility", "strategy-innovation", "institutional-theory"]
unit_of_analysis: "firm"
level_of_theory: "macro"
dependent_variable_family: "financial"
methods: "Panel study of Chinese listed firm-years using CSR activity data, analyst coverage and recommendation data, and CSMAR firm-level data; the main models are firm fixed-effects regressions, with robustness checks using instrumental variables, first-difference regressions, dose-response functions, and an alternative multidimensional-scaling measure of emphasis differentiation."
sample:
  industry: "Chinese listed firms reporting CSR activities across multiple issue fields; no single industry is specified."
  country: "China."
  time_period: "2008 to 2014."
  units: "Firm-year observations for Chinese listed firms that reported CSR activities."
  n: "3,230 firm-year observations."

evidence:
  sample_n: "The final sample totaled 3,230"
  sample_country: "China’s public listed firms"
  sample_industry: "Chinese listed firms that reported CSR activities"
  sample_time_period: "2008 to 2014"
...
- Moderators: State ownership; firm visibility; high-status houses coverage; earnings pressure.
...
For executives designing social programs, the findings suggest that investors and analysts attend to nonfinancial metrics as well as financial metrics. Firms may gain basic legitimacy by covering important CSR fields consistent with reporting frameworks, but they also need CSR emphasis that fits their competitive positioning and stakeholder context. Managers should therefore avoid treating CSR rankings or broad coverage alone as sufficient, and should orchestrate overt scope conformity with substantive emphasis differentiation.

**Limitations**
The paper notes that its differentiation measure captures the number of social activities in CSR fields but not the qualitative uniqueness of each activity. It also acknowledges that the Chinese listed-firm CSR setting is especially useful because scope guidelines and open-ended emphasis make the conformity-differentiation contrast salient, but this context may not generalize without nuance. Finally, the paper finds only scant supplementary evidence on learning over time by firms and analysts, leaving that process underexplored.

**Future Research**
Future research could develop more comprehensive measures of CSR differentiation that capture qualitative differences in specific activities within each CSR field. Studies could also examine whether firms and analysts learn over time to balance, orchestrate, and evaluate CSR conformity and differentiation. The authors suggest applying the framework to other complex management practices, including total quality management and diversity programs, and to CSR contexts outside China.

**APA 7th Citation**
Zhang, Y., Wang, H., & Zhou, X. (2020). Dare to be different? Conformity versus differentiation in corporate social activities of Chinese firms and market responses. *Academy of Management Journal*, 63(3), 717-742. https://doi.org/10.5465/amj.2017.0412
