---
id: amj-vol-63-no-4-bourgoin-2020
...
doi: "https://doi.org/10.5465/amj.2017.1335"
volume: 63
issue: 4
pages: "1134-1165"

source: "AMJ/vol-63-no-4"
pdf_path: "library/AMJ/vol-63-no-4/pdfs/Bourgoin 2020 “And Who Are You” A Performative Perspective on Authority in Organizations.pdf"
...
theory: ["actor-network theory", "communicative constitution of organizations", "performativity", "relational authority"]
...
methods: "Analytic autoethnography of a six-month consulting assignment, using observations, field notes, field documents, informal conversations, follow-up meetings, and grounded-theory coding of empirical episodes."
sample:
  industry: "Management consulting in a French energy-sector restructuring assignment."
  country: "French business context."
  time_period: "2011, over a six-month EnergyCorp assignment."
  units: "One focal consultant, one restructuring assignment, human allies, material artifacts, abstract entities, and episodes in which authority was on trial."
  n: "13 empirical episodes selected from a six-month autoethnography, supported by field notes, documents, 124 reported informal conversations, and nine follow-up meetings."

evidence:
  sample_n: "we analyze 13 empirical episodes"
  sample_country: "research within French businesses"
  sample_industry: "world-leading French multinational in the energy sector"
  sample_time_period: "2011, over a span of six months"
...
- Key actants: human allies, material artifacts, and abstract entities.
- Activation movements: mobilizing human allies, equipping with material artifacts, and invoking abstract entities to foreground relations with other actants.
- Passivation movements: distancing from human allies, gearing down from material artifacts, and revoking abstract entities to background relations with other actants.
- Situational adjustment: activation and passivation are not fixed alternatives; the consultant adjusted between them as situations changed and as prior attempts succeeded or failed.
- Emergent outcome: collective action proceeds when actants align with the demand of the situation and remains impeded when they do not.
...
For consultants, managers, and other actors working without clear hierarchical authority, the paper implies that authority depends on how they bring people, artifacts, methods, and principles into or out of the situation. Actors should not assume that credentials, rank, expertise, or a mandate will automatically orient collective action; these resources must be made to count in specific encounters. The findings also warn that downplaying others' contributions may help in one audience but damage relations or legitimacy with another.
