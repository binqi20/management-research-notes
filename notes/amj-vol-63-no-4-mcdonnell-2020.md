---
id: amj-vol-63-no-4-mcdonnell-2020
...
doi: "https://doi.org/10.5465/amj.2017.0890"
volume: 63
issue: 4
pages: "1028-1053"

source: "AMJ/vol-63-no-4"
pdf_path: "library/AMJ/vol-63-no-4/pdfs/McDonnell 2020 Take a Stand or Keep Your Seat Board Turnover after Social Movement Boycotts.pdf"
...
theory: ["self-determination theory", "social identity and organizational identification", "identity threat", "rigidity of the right hypothesis"]
topics: ["corporate-social-responsibility", "board-of-directors", "corporate-political-activity", "self-determination-theory"]
unit_of_analysis: "individual"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Empirical quantitative archival study of social movement boycotts and director turnover. The paper constructs a hand-collected boycott dataset, validates boycotts as turnover-inducing crises using difference-in-differences with matched controls and fractional logit models, and tests director-level exit using two-stage Heckman selection logic and logit models with standard errors clustered by boycott."
sample:
  industry: "Publicly listed firms targeted by social movement boycotts, matched to Compustat and ISS/RiskMetrics; the sample spans multiple industries rather than one named sector."
  country: "United States context; boycotts were identified from major U.S. media outlets and director ideology was measured from U.S. Federal Election Commission records, but the paper does not state that all firms were U.S.-headquartered."
  time_period: "Boycotts occurring between 2000 and 2014."
  units: "Firm-boycott observations and directors serving on targeted firms' boards."
  n: "120 firm-boycott observations for the main boycott sample; director-level models use 102 firm-boycott events and 1,137 observations after missing controls."

evidence:
  sample_n: "the 120 boycotts in our sample"
  sample_country: "six largest U.S. media outlets"
  sample_industry: "brought against publicly listed firms"
  sample_time_period: "boycotts occurring between 2000 and 2014"
...
- Mediators: Identity threat and organizational identification are theorized mechanisms; they are probed indirectly through aligned and misaligned ideology interactions rather than directly measured.
...
Boards facing contentious social challenges should expect director retention risks to vary by directors' own values and by the ideological valence of the challenge. The findings imply that polarized social issues can produce both exit and entrenchment inside the boardroom, complicating assumptions that social activism has uniform governance effects. Activists and firms should also recognize that boycotts may unintentionally demotivate sympathetic insiders while strengthening opponents' attachment to the firm.

**Limitations**
The authors could not directly observe directors' reasons for leaving, because firms usually do not disclose detailed rationales for board departures and directors may be constrained from discussing exits publicly. Political contributions are also a coarse proxy for ideological alignment, and they may miss within-issue salience, party inconsistency, and differences between social and fiscal conservatism. Finally, identity threat and identification are inferred from patterns in archival data rather than directly measured.

**Future Research**
Future research could examine how activism shapes employee attrition, recruitment, and insider willingness to champion reform after contentious challenges. The authors call for finer-grained measures of ideological alignment, including survey approaches that can capture issue-level values more directly. They also suggest direct tests of identification and identity threat in lower-level employee contexts, potentially using surveys or field experimental designs.

**APA 7th Citation**
McDonnell, M.-H., & Cobb, J. A. (2020). Take a stand or keep your seat: Board turnover after social movement boycotts. *Academy of Management Journal*, 63(4), 1028-1053. https://doi.org/10.5465/amj.2017.0890
