...
doi: "https://doi.org/10.5465/amj.2018.0229"
volume: 63
issue: 5
pages: "1535-1560"

source: "AMJ/vol-63-no-5"
pdf_path: "library/AMJ/vol-63-no-5/pdfs/Tong 2020 Stakeholder Preservation or Appropriation The Influence of Target CSR on Market Reactions to Acquisition Announcements.pdf"
...
theory: ["stakeholder preservation perspective", "stakeholder appropriation perspective", "implicit contracts"]
topics: ["corporate-social-responsibility", "csr-strategy", "mergers-acquisitions", "corporate-finance"]
unit_of_analysis: "firm"
level_of_theory: "macro"
dependent_variable_family: "financial"
methods: "Quantitative event-study and regression analysis of U.S. public-firm acquisition deals, using SDC, KLD, CRSP, Compustat, ExecuComp, patent, and occupational data; acquirer announcement returns are estimated with Eventus and tested with Heckman two-stage models with robust standard errors clustered by acquirer."
sample:
  industry: "Acquisition, merger, and majority-interest acquisition deals across industries; no single focal industry reported"
  country: "United States"
  time_period: "Deals from 2000-2012, with lagged KLD, ExecuComp, Compustat, and moderator variables from 1999-2011"
  units: "Acquisition deals involving U.S. public firms"
  n: "237 deals"

evidence:
  sample_n: "our final sample included 237 deals"
  sample_country: "acquisitions in the United States"
  sample_industry: "acquisition, merger, and acquisition of majority interests"
  sample_time_period: "2000 and 2012"
...
For acquirer managers, the study suggests that target stakeholders should be considered a source of acquisition value, not merely a cost or redundancy to be removed. The authors advise managers to pay attention to preserving target stakeholders' implicit contracts and eliciting their cooperation, while avoiding blind protection of ineffective or unhelpful stakeholder arrangements. The findings also caution managers not to assume that all forms of similarity between merging firms are beneficial, because business similarity may undermine value creation from target CSR.

**Limitations**
The authors could not directly measure how target stakeholders behaved or reacted during acquisition integration, so the mechanism is inferred from announcement returns and contingency patterns. Their business similarity measure incorporates multiple resource and strategy dimensions but may not fully capture all strategic similarities between acquirer and target. The sample is limited to large U.S. public firms covered by KLD, and the study relies on net CSR scores from KLD data, which the authors acknowledge have measurement limitations.

**Future Research**
Future research could directly measure stakeholder preservation and appropriation during acquisition integration using qualitative, survey, or value-creation-and-distribution approaches. Additional studies could examine contexts in which appropriation may matter more, such as labor-intensive industries or later stages of integration. Future work could also distinguish primary from secondary stakeholders, internal from external stakeholders, smaller firms, non-U.S. settings, and alternative CSR data sources or measures.

**APA 7th Citation**
Tong, L., Wang, H., & Xia, J. (2020). Stakeholder preservation or appropriation? The influence of target CSR on market reactions to acquisition announcements. *Academy of Management Journal*, 63(5), 1535-1560. https://doi.org/10.5465/amj.2018.0229
