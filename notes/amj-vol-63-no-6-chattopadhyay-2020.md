---
id: amj-vol-63-no-6-chattopadhyay-2020
...
doi: "https://doi.org/10.5465/amj.2017.0744"
volume: 63
issue: 6
pages: "1807-1839"

source: "AMJ/vol-63-no-6"
pdf_path: "library/AMJ/vol-63-no-6/pdfs/Chattopadhyay 2020 Geographical Dissimilarity and Team Member Influence Do Emotions Experienced in the Initial Team Meeting Matter.pdf"
...
theory: ["social identity theory (Tajfel & Turner, 1986)", "self-categorization theory (Turner, 1987)", "emotions and decision-making research"]
topics: ["organizational-behavior-hrm", "teams-collaboration", "emotions-at-work", "social-identity-theory"]
unit_of_analysis: "individual"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Two-study quantitative survey design with MBA project teams; peer-rated perceived influence was analyzed with multilevel models using PROC MIXED in SAS to test interactions between geographical dissimilarity and emotion categories over time."
sample:
  industry: "MBA student project teams in management education settings."
  country: "Study 1 used MBA students at a university in Hong Kong; Study 2 used MBA students at an Indian business school."
  time_period: "Study 1 followed teams over about two months; Study 2 followed a first-term project lasting three months."
  units: "Individual MBA students nested in project teams."
  n: "192 complete Study 1 responses in 48 teams; 338 complete Study 2 responses in 75 teams."

evidence:
  sample_n: "A total of 338 students"
  sample_country: "MBA students at a university in Hong Kong"
  sample_industry: "Data were collected through multiple surveys"
  sample_time_period: "lasting the entire three months"
...
Managers of geographically diverse teams should treat initial team meetings as consequential moments for later influence patterns. The paper suggests designing early activities that elicit pleasant high-activation emotions among highly dissimilar members, helping low-activation members gain earlier access to decision making, and tempering the later abrasiveness of members experiencing unpleasant high-activation emotions. It also points to emotional awareness and management training as useful supports for diverse project teams.

**Limitations**
The evidence comes from MBA student project teams rather than organizational teams, and the authors note that the projects were relatively short. Study 1 could not rule out whether the observed effects came from repeated later emotions, which is why Study 2 added trait-emotion controls and later emotion checks. The conclusions about unpleasant high-activation emotions are explicitly more tentative because the full predicted pattern could not be tested symmetrically across both studies.

**Future Research**
Future research should test whether the findings replicate in longer organizational projects and in settings beyond MBA teams. The authors also call for work on whether transient emotions have long-term consequences in other team processes, such as creativity. They suggest examining other forms of dissimilarity, such as gender or race, when both positive and negative aspects of dissimilarity are salient.

**APA 7th Citation**
Chattopadhyay, P., George, E., Li, J., & Gupta, V. (2020). Geographical dissimilarity and team member influence: Do emotions experienced in the initial team meeting matter? *Academy of Management Journal*, 63(6), 1807-1839. https://doi.org/10.5465/amj.2017.0744
