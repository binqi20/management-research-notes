---
id: amj-vol-63-no-6-derfler-rozin-2020
...
doi: "https://doi.org/10.5465/amj.2017.0617"
volume: 63
issue: 6
pages: "1840-1864"

source: "AMJ/vol-63-no-6"
pdf_path: "library/AMJ/vol-63-no-6/pdfs/Derfler-Rozin 2020 Motivation Purity Bias Expression of Extrinsic Motivation Undermines Perceived Intrinsic Motivation and Engenders Bias in Selection Decisions.pdf"
...
theory: ["popular management myths", "self-determination theory", "motivation purity bias", "impression management"]
topics: ["organizational-behavior-hrm", "motivation-engagement", "hr-practices", "self-determination-theory"]
unit_of_analysis: "individual"
level_of_theory: "micro"
dependent_variable_family: "social"
methods: "Four-study empirical quantitative design using hiring simulations, cover letters, interview scripts, video and transcript stimuli, business-school student samples, online participant samples, and hiring-manager samples; analyses include logistic and OLS regressions, clustered standard errors, bootstrapped indirect effects, and an internal random-effects meta-analysis."
sample:
  industry: "Organizational selection for salaried employment; Study 2 used a project finance consultant hiring simulation and Studies 3a/3b used a general project manager selection context. Participants included business school students, online respondents, and hiring managers."
  country: "Partly not reported in paper; Studies 3a and 3b recruited hiring managers through a U.S.-based market research organization."
  time_period: "Not reported in paper"
  units: "Individual job candidates or candidate profiles evaluated by individual decision makers in hiring simulations."
  n: "Four main studies plus supporting pilots/pretests; main study samples included 256 candidate-perspective business students and 310 decision-maker students in Study 1, 302 online participants in Study 2, 239 hiring managers in Study 3a, and 247 hiring managers in Study 3b."

evidence:
  sample_n: "Four studies conducted among hiring managers and business school students"
  sample_country: "a U.S.-based market research organization"
  sample_industry: "a project finance consultant job"
...
- Mediators: Perceived intrinsic motivation is the theorized and tested mediator linking expressed extrinsic motivation to selection outcomes.
...
The paper suggests that organizations should reduce opportunities for decision makers to penalize benign discussion of extrinsic job features, for example by making salary, benefits, and flexibility information available early and limiting unnecessary motive-based interpretation during selection. It also implies that training or selection-process design should correct the assumption that extrinsic interest necessarily signals low intrinsic motivation. For candidates, the authors note the uncomfortable implication that openly volunteering high extrinsic motivation may trigger bias rather than provide useful information to employers.

**Limitations**
The authors describe the investigation as the first test of the phenomenon and state that more research is needed on generalizability, robustness, and actionable boundary conditions. They used multiple methods and samples, but the research was largely experimental and did not include access to real hiring notes or naturally occurring interview records. The paper also leaves open whether motivation purity bias harms some candidates more than others, especially those with stronger needs for money, time flexibility, or other extrinsic job features.

**Future Research**
Future research should test motivation purity bias with real hiring notes, real interviews, and other consequential organizational decisions. The authors call for work on whether the bias disproportionately harms candidates who need or must discuss extrinsic job features, and whether it is stronger for particular candidate groups such as women. They also encourage broader research on naive views of motivation and the possibility that people undervalue extrinsic motivation in domains beyond selection.
