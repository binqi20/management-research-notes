---
id: amj-vol-63-no-6-dorobantu-2020
...
doi: "https://doi.org/10.5465/amj.2017.0265"
volume: 63
issue: 6
pages: "1775-1806"

source: "AMJ/vol-63-no-6"
pdf_path: "library/AMJ/vol-63-no-6/pdfs/Dorobantu 2020 Political Risk and Alliance Diversity A Two-Stage Model of Partner Selection in Multipartner Alliances.pdf"
...
theory: ["institutional theory", "multipartner alliance partner selection", "interorganizational diversity and coordination costs"]
topics: ["corporate-political-activity", "risk-management", "public-policy", "institutional-theory"]
unit_of_analysis: "multi-level"
level_of_theory: "macro"
dependent_variable_family: "social"
methods: "Two-stage quantitative study of infrastructure project-finance banking syndicates. The first stage estimates lead-firm selection with hierarchical binomial multivariable logistic regression and project fixed effects; the second stage compares realized syndicates with simulated counterfactual syndicates using hierarchical GLM models with logistic links, random effects, and robustness checks on sampling, specification, and construct measurement."
sample:
  industry: "Infrastructure project finance banking syndicates financing large-scale infrastructure projects."
  country: "68 countries."
  time_period: "2003 to 2012."
  units: "Projects, potential lead firms, realized syndicates, and unrealized counterfactual syndicates."
  n: "1,044 projects; 96,521 potential lead-firm observations; 1,044 realized syndicates and 33,460 counterfactual syndicates."

evidence:
  sample_n: "1,044 projects in our sample, and 33,460 counterfactual syndicates"
  sample_country: "68 countries funded between 2003 and 2012"
  sample_industry: "loans to large-scale infrastructure projects"
  sample_time_period: "between 2003 and 2012"
...
- Mediators: Not modeled as statistical mediators; country knowledge and political influence are theorized as resources that help alliances manage political risk.
...
For lead firms and project sponsors in politically risky infrastructure settings, the findings imply that partner selection should account for the alliance's collective country knowledge and political influence, not only dyadic fit or low coordination costs. The paper also suggests that more diverse syndicates may be strategically useful when political risk makes host-country resources especially valuable. Managers should therefore treat diversity-related coordination costs as part of a tradeoff against political-risk management needs.

**Limitations**
The study focuses on regulatory or political institutions, so it does not test how cognitive, normative, or other institutional pillars shape partner selection. Its empirical setting is infrastructure project finance, where political interference is salient and banking syndicates have observable lead-firm and partner-selection structures. The authors also note that institutional context may shape the pool of potential partners itself, even though their empirical approach accounts for this possibility.

**Future Research**
Future research could examine regulatory uncertainty and other pillars of institutional theory in partner selection and alliance diversity. It could also test whether the findings generalize to other regulated settings such as energy, mining, transportation, agriculture, banking, biotech, pharmaceuticals, education, health care, and real estate. Additional work could examine how political risk affects alliance size and whether firms respond to rising political risk by reaching beyond prior alliance partners.
