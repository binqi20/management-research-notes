---
id: amj-vol-63-no-6-rodell-2020
...
doi: "https://doi.org/10.5465/amj.2018.0354"
volume: 63
issue: 6
pages: "1714-1738"

source: "AMJ/vol-63-no-6"
pdf_path: "library/AMJ/vol-63-no-6/pdfs/Rodell 2020 “Tapping” into Goodwill Enhancing Corporate Reputation through Customer Volunteering.pdf"
...
theory: ["corporate reputation and sensemaking theory", "emotional contagion theory"]
topics: ["corporate-social-responsibility", "csr-strategy", "stakeholder-engagement", "consumer-psychology"]
unit_of_analysis: "individual"
level_of_theory: "micro"
dependent_variable_family: "mixed"
methods: "Sequential mixed-method field study at a local microbrewery: Study 1 used observation, informal interviews, and 48 semi-structured customer interviews with open, axial, and selective coding; Study 2 used multisource, three-wave survey data from volunteering customers and friends, analyzed with structural equation modeling in Mplus using bias-corrected bootstrapping and FIML."
sample:
  industry: "Local microbrewery corporate community engagement program involving customer volunteering."
  country: "Not reported in paper"
  time_period: "Five-month weekly volunteering program; quantitative customer and friend surveys included Time 1, Time 2 one month later, and Time 3 two years later."
  units: "Customer volunteers and recruited friends of customer volunteers."
  n: "Study 1 included 48 formal semi-structured interviews; Study 2 included 140 volunteering customers at Time 1, 113 usable customer responses at Time 2, 65 usable customer responses at Time 3, 93 usable friend responses at Time 2, and 35 usable friend responses at Time 3."

evidence:
  sample_n: "A total of 48 formal, semi-structured interviews"
  sample_country: "Not reported in paper"
  sample_industry: "local microbrewery"
  sample_time_period: "entire five-month period"
...
- Mediators: Customer perceptions of company reputation; friends' emotional contagion and perceptions of company reputation.
...
The findings suggest that firms with community engagement programs may benefit from involving customers, especially when the volunteering experience helps customers engage directly with a prosocial activity and with the firm. For managers, the paper frames customer volunteering as a possible win-win: the company may build reputation and financially supportive behaviors while broadening community participation. The authors are careful that this implication is most directly supported for settings resembling their field context: an on-site, customer-facing, local volunteering program.

**Limitations**
The study is constrained by recruitment from an existing volunteering initiative at one local microbrewery, with a relatively low response rate and smaller two-year follow-up samples. The behavioral outcomes are self-reported rather than objectively observed attendance or purchase records. The authors also note that serial mediation effects have low explanatory power and that generalizability may depend on industry, program structure, customer-facing physical presence, local image, and company size or novelty.

**Future Research**
Future research should examine customer volunteering in different industries and program structures, including activities held at nonprofits and activities with direct beneficiary interaction. The authors call for work on how customer involvement fits into broader system-level dynamics of corporate community engagement and business strategy. They also encourage a more macro approach to studying how volunteering programs should be structured and how they connect to a company's larger strategy.

**APA 7th Citation**
Rodell, J. B., Sabey, T. B., & Rogers, K. M. (2020). “Tapping” into goodwill: Enhancing corporate reputation through customer volunteering. *Academy of Management Journal*, 63(6), 1714-1738. https://doi.org/10.5465/amj.2018.0354
