...
The findings imply that executives and investor-relations teams should treat earnings-call Q&A sessions as a consequential communication setting, not merely as a scripted disclosure ritual. Providing new information, using simpler language, and responding in a less scripted manner are associated with greater investor opinion convergence, especially when earnings uncertainty is high. The paper also notes a tradeoff: less scripted communication may increase information value and perceived credibility, but it can also raise the risk of mistakes or unpolished delivery.
