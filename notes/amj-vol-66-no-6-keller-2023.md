---
id: amj-vol-66-no-6-keller-2023
...
doi: "https://doi.org/10.5465/amj.2021.1174"
volume: 66
issue: 6
pages: "1831-1859"

source: "AMJ/vol-66-no-6"
pdf_path: "library/AMJ/vol-66-no-6/pdfs/Keller 2023 Advance ’Em to Attract ’Em How Promotions Influence Applications in Internal Talent Markets.pdf"
...
keywords:
  ...
  - "job applications"
theory:
  - "signaling theory (Connelly, Certo, Ireland, & Reutzel, 2011)"
  - "career sponsorship (Seibert, Kraimer, & Liden, 2001)"
  - "talent hoarding / employee guarding (Dineen, Ling, & Soltis, 2011; Gardner, Munyon, Hom, & Griffeth, 2018)"
topics:
  - "hr-practices"
...
methods: "Negative binomial regression on job-posting-level archival panel data with extensive controls and fixed effects (job type, business unit, U.S. region, year); robustness checks with two-year promotion rates, decomposed numerator/denominator, binary operationalizations, manager-mover subsamples, and in-group/lateral-move comparisons. Complemented by 30 semi-structured manager interviews across four firms, iteratively coded to identify mechanisms."
sample:
  industry: "Health services (primary site HealthCo); supplementary interviews at a vehicle manufacturer, a global beauty products firm, and a European manufacturing products firm"
  country: "United States (HealthCo); supplementary interviews in U.S. and Europe"
  time_period: "2013–2017 (five-year archival window); application data 2014–2017; interviews conducted at four firms"
  units: "Internal job postings; supplementary unit: manager interviews"
  n: "9,896 internal job postings; 96,712 internal applications; 3,431 hiring managers; 30 semi-structured manager interviews"

evidence:
  sample_n: "Our analysis of 96,712 internal applications submitted to"
  sample_country: "single U.S.-based organization. HealthCo's internal"
  sample_industry: "9,896 jobs over a five-year period within a large organization reveals that managers"
  sample_time_period: "9,896 jobs over a five-year period within a large organization reveals that managers"
...
- Mediators: Not directly modeled; qualitative interviews probe underlying mechanisms (visibility of promotions, managerial reputations as "sponsors" vs. "hoarders," word-of-mouth)
...
HR functions should educate managers that hoarding talent reduces their long-run ability to attract internal applicants, while encouraging subordinates’ advancement enlarges and improves the future applicant pool. Firms can incentivize managers for facilitating internal mobility, and HR business partners can broker backfill pipelines so reluctant managers feel less exposed when they let strong subordinates go.

**Limitations**
The quantitative study is set in a single U.S.-based health services firm, so generalizability requires replication. The archival data do not directly measure employee perceptions, sponsorship, or hoarding behaviors, and the relatively short observation window precludes examining how subordinates perform after being promoted. The independent variable is a ratio, which can be sensitive to denominator dispersion, and the design isolates a main effect without weighing it against other application drivers.

**Future Research**
Pairing archival data with surveys would clarify how employees perceive managers’ reputations and weigh promotion signals against other job attributes. Researchers could examine longer observation windows that incorporate the subsequent performance of promoted subordinates, test boundary conditions (e.g., smaller firms with greater promotion visibility), and explore when managers benefit from supporting subordinates’ external advancement.

**APA 7th Citation**
Keller, J. R., & Dlugos, K. (2023). Advance ’em to attract ’em: How promotions influence applications in internal talent markets. *Academy of Management Journal*, 66(6), 1831–1859. https://doi.org/10.5465/amj.2021.1174
