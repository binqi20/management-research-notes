---
id: amj-vol-67-no-4-dwivedi-2023
...
pdf_path: "library/AMJ/vol-67-no-4/pdfs/Dwivedi 2023 Tick Off the Gender Diversity Box Examining the Cross-Level Effects of Women’s Representation in Senior Management.pdf"
...
theory: ["attention-based view of the firm (Ocasio, 1997)", "practice-based attention (Feldman & Orlikowski, 2011)", "critical mass theory (Kanter, 1977)"]
topics: ["diversity-equity-inclusion", "gender-in-organizations", "dei-initiatives"]
unit_of_analysis: "firm"
level_of_theory: "cross-level"
dependent_variable_family: "social"
methods: "Longitudinal panel analysis (2007-2015) using population-averaged negative binomial regression with generalized estimating equations; Sobel mediation tests; ITCV endogeneity sensitivity analysis; supplementary qualitative interviews with 38 decision-makers"
sample:
  industry: "Largest U.S. corporate law firms (legal services)"
  country: "United States"
  time_period: "2007-2015"
  units: "Law firms (firm-year observations)"
  n: "193 law firms, 1,202 firm-year observations"

evidence:
  sample_n: "193 law firms and 1,202 firm-year observations"
  sample_country: "a panel dataset on the largest U.S. law firms"
  sample_industry: "panel dataset on the largest U.S. law firms"
  sample_time_period: "from 2007 to 2015"
...
- Mediator: Engagement with internal diversity practices (averaged 0-3 score across six internal diversity initiatives)
- Moderator: Substantive representation of women on diversity and hiring committees (proportion of women across both committees)
...
Organizations should pursue a dual strategy: simultaneously increasing women's representation in senior management while appointing a critical mass of women across ranks to diversity and hiring committees. Firms should formally specify diversity tasks in role prescriptions and reward systems for both men and women managers to avoid placing the burden of diversity work disproportionately on women. Firms must avoid treating senior gender diversity as a "tick-the-box" exercise.

**Limitations**
The data are survey-based archival data, which precludes definitive causal claims and does not directly capture the proposed attentional mechanism. The study is limited to large U.S. law firms in a male-dominated industry, raising questions about generalizability to gender-balanced or smaller-firm contexts. Alternative theoretical mechanisms (e.g., moral licensing, threshold effects) were not directly tested.
