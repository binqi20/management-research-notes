...
theory: ["dirty work theory (Ashforth & Kreiner, 1999; Hughes, 1951)", "stigma theory (Goffman, 1963)", "social evaluations (Helms & Patterson, 2014; Piazza & Augustine, 2022)"]
topics: ["organizational-behavior-hrm", "business-ethics", "identity-theory"]
unit_of_analysis: "individual"
level_of_theory: "micro"
dependent_variable_family: "social"
methods: "Grounded theory, inductive/abductive qualitative study based on 98 semi-structured remote interviews (60-90 minutes) with healthcare workers, plus a member-checking follow-up survey (n=20) in late 2021/early 2022; two-step coding system with iterative theoretical-memo writing."
sample:
  industry: "Healthcare (hospitals, long-term care, clinics)"
  country: "Primarily United States (n=92), with 6 from South America"
  time_period: "Interviews during the COVID-19 pandemic; member checking late 2021 and early 2022"
  units: "Healthcare workers (nurses, physicians, physician assistants, administrators, other clinicians)"
  n: "98 interviews; 20 follow-up member-checking respondents"

evidence:
  sample_n: "Our 98 participants (see Table 1"
  sample_country: "92                          United States"
  sample_industry: "represent a broad and diverse group of workers from"
  sample_time_period: "with 20 respondents in late 2021 and early 2022"
...
- Spatial-distance dynamic: at high distance, evaluators emphasize moral dimensions ("heroes"); at close distance, physical/social taint becomes salient ("don't get near me").
- Evaluating-the-evaluator criteria: workers appraise each evaluation along proximity, informedness, and authenticity of the source.
- Internalization outcomes: (a) acceptance — supporting supporters (pride/gratitude) or condoning condemners (empathizing/blaming other factors); (b) partial/full rejection — discounting/condemning supporters (insufficient, did-not-motivate, annoyance/anger) or discounting condemners (feeling ostracized, avoidance/concealing).
...
Praising an entire workforce can backfire when not paired with concrete material support; idealization at a distance can substitute for needed action and may compound psychological stress. Organizations and managers should align stigma management tactics with the actual stigmatized dimension of work, remove distances, demonstrate informed understanding, and pair recognition with authentic, targeted resources (staffing, PPE, compensation) so that evaluations are perceived as authentic rather than as impression management.

**Limitations**
The authors interviewed only healthcare workers, not the evaluators themselves; the front end of the model is therefore inferred abductively from workers' accounts of how others treated them. The sample is heterogeneous and largely U.S.-based (with a small South American subsample), limiting cross-country generalization, and the moral and regulatory legitimacy of healthcare may bound the findings. Quantitative validation of the proposed criteria and dimension combinations remains untested.
