...
doi: "https://doi.org/10.5465/amj.2022.0380"
volume: 67
issue: 6
pages: "1612-1633"

source: "AMJ/vol-67-no-6"
pdf_path: "library/AMJ/vol-67-no-6/pdfs/Yin 2024 The Interactive Effects of Abusive CEOs and Philanthropic Corporate Social Responsibility on Organizational Innovation and Performance.pdf"
...
theory:
  - "upper echelons theory (Hambrick & Mason, 1984; Hambrick, 2007)"
  - "CEO-TMT interface / strategic leadership interface perspective (Simsek, Heavey & Fox, 2018; Georgakakis et al., 2022)"
  - "abusive leadership / abusive supervision (Tepper, Simon & Park, 2017; Mitchell & Ambrose, 2007)"
  - "leader hypocrisy (Brunsson, 1989; Greenbaum, Mawritz & Piccolo, 2015)"
  - "philanthropic CSR (Carroll, 1991; Homburg, Stierl & Bornemann, 2013)"
topics:
  - "ceo-leadership"
  - "csr-strategy"
  - "leadership-behavior"
...
methods: "Two complementary survey-based studies of Chinese SMEs testing a moderated-mediation model. Study 1 (n=308 SMEs, March 2018, East China): cross-sectional multi-source survey design with CEOs reporting TMT behavioral integration, COOs reporting philanthropic CSR, and CMOs reporting CEO abusive leadership; objective innovation (percentage of sales from new products) and ROA collected from a partner agency one year later. Study 2 (n=287 SMEs, 2022, multiple Chinese cities): preregistered three-wave time-lagged multisource design with TMT members rating CEO abusive leadership at T1 and TMT behavioral integration at T2 (three months later), CEOs rating philanthropic CSR at T1 and providing objective innovation/ROA at T3 (six months later). Hypotheses tested via path analysis with item-parceled CFA (Mplus 8.3), grand-mean centered interaction terms, simple-slope tests at +/-1 SD of philanthropic CSR, and Monte Carlo confidence intervals (10,000 bootstrapped samples) for moderated mediation indices."
sample:
  industry: "Small and medium-sized enterprises (SMEs) across multiple industries; Study 2 specifically targeted high-tech industrial parks and enterprise associations (including foreign equity joint-venture associations)"
  country: "China — Study 1 from East China; Study 2 from major Chinese cities including Hefei, Nanjing, Shanghai, Shenzhen, and Suzhou"
  time_period: "Study 1: survey March 2018, objective outcomes one year later. Study 2: T1 June 2022, T2 three months later (~Sept 2022), T3 six months after T1 (~Dec 2022)"
  units: "Firms (SMEs); subjective constructs aggregated from CEO, COO, CMO (Study 1) and CEO + multiple TMT members (Study 2, mean 3.43 TMT members per firm); objective firm-level outcomes from external agency"
  n: "Study 1: 308 SMEs (after merging 316 CEOs and 717 TMT members), 26.67% response rate. Study 2: 287 SMEs (287 CEOs + 972 TMT members), 6.64% effective response rate"

evidence:
  sample_n: "received responses from 308 SMEs"
  sample_country: "Chinese cities (e.g., Hefei, Nanjing, Shanghai"
  sample_industry: "data were obtained from 15 high-tech industrial"
  sample_time_period: "in March 2018"
...
**Future Research**
Future research should employ longitudinal or experimental designs to strengthen causal inference; consider TMT member attributions of CEO abusive leadership and possible trickle-down effects in which abusive CEOs spawn abusive TMT members; explore alternative mediating mechanisms such as TMT trust, fear, and psychological safety; examine how external stakeholders react when they observe internal mistreatment; investigate the antecedents of CEO abusive leadership (why some CEOs become abusive); and contrast organizational philanthropic CSR with CEOs' personal charity engagements as separate moderators of the abusive-leadership-to-outcomes pathway.

**APA 7th Citation**
Yin, J., Wu, Y., Liden, R. C., Kluemper, D., Sauerwald, S., & Gu, J. (2024). The interactive effects of abusive CEOs and philanthropic corporate social responsibility on organizational innovation and performance. *Academy of Management Journal*, 67(6), 1612-1633. https://doi.org/10.5465/amj.2022.0380
