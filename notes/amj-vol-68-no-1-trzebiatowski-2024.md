---
id: amj-vol-68-no-1-trzebiatowski-2024
...
pdf_path: "library/AMJ/vol-68-no-1/pdfs/Trzebiatowski 2024 A Diversity Signal Set Perspective Examining Interactive Effects of Diversity Practices on Women and Racialized Non-Leader and Leader Turnover.pdf"
...
keywords:
  ...
  - "signaling theory"
  - "signal set congruence and incongruence"
  - "role theory"
  - "resource practices"
  - "non-discrimination practices"
  - "accountability practices"
  - "women and racialized employees"
  - "non-leaders and leaders"
  - "turnover"
  - "concerns about unfair treatment"
  - "personal relevance"
theory:
  - "signaling theory (Spence, 1973; Connelly et al., 2011)"
  - "cognitive view of signaling theory / signal set congruence-incongruence (Drover, Wood & Corbett, 2018)"
  - "role theory (Biddle, 1979, 1986)"
  - "diversity initiative effectiveness model (Nishii et al., 2018; Leslie, 2019)"
  - "Bowen and Ostroff (2004) HRM strength framework"
topics:
  - "dei-initiatives"
...
methods: "Two-study mixed-methods design. Study 1 is a longitudinal panel field study using fractional logit regressions with firm and year fixed effects and cluster-robust standard errors on archival data from Vault and the Minority Corporate Counsel Association (MCAA) Law Firm Diversity Database, hand-coding diversity practices into Leslie's (2019) resource, non-discrimination, and accountability typology and predicting turnover rates of women and racialized associates (non-leaders) and partners (leaders) for the year of the practice measures, using turnover reported in the following year's survey; Tobit fixed-effects models used as robustness checks. Study 2 is a preregistered 2x2x2 between-person experimental vignette study (separate non-leader and leader samples on Prolific) using ANOVA and Mplus path modeling with 5,000 bias-corrected bootstrap resamples to test mediated three-way interaction effects of manipulated resource, non-discrimination, and accountability practices on concerns about unfair treatment, personal relevance, and turnover intention; manipulation checks, confirmatory factor analyses, and supplementary content-validity (Q-sort/ANOVA) and personal-relevance validation samples support the measures."
sample:
  industry: "Study 1: large U.S. law firms (associates and partners); Study 2: women and racialized non-managers and managers across industries recruited via Prolific."
  country: "Study 1: United States (firms with U.S.-based attorney staff); Study 2: U.S.-employed Prolific participants."
  time_period: "Study 1: 2010-2018 turnover years (diversity practices coded from 2010-2019 Vault/MCAA surveys); Study 2: data collected for two preregistered experiments (no calendar window reported)."
  units: "Study 1: firm-year observations of law firms (associates and partners as separate models). Study 2: individual women and racialized non-managers (non-leaders) and supervisors (leaders) randomly assigned to one of eight diversity-practice scenarios."
  n: "Study 1: 280 firms / 1,608 firm-year observations for non-leaders and 270 firms / 1,572 firm-year observations for leaders. Study 2: 650 non-leaders and 661 leaders."

evidence:
  sample_n: "n 5 270–280 law firms"
  sample_country: "Large U.S. law"
  sample_industry: "a sample of large law firms"
  sample_time_period: "longitudinal panel data from 2010 to 2018"
...
- DVs: women-and-racialized non-leader (associate) turnover rate and women-and-racialized leader (partner) turnover rate at the firm-year level (Study 1); turnover intention at the individual level (Study 2).
- Manipulated IVs (Study 2): high vs. low resource, non-discrimination, and accountability practices in a 2x2x2 between-person vignette about a fictional company "Ascentira."
- Mediators (Study 2, individual level): concerns about unfair treatment (non-leaders); personal relevance (leaders).
- Moderation logic: the focal three-way interaction is theorized as resource practices moderated jointly by the safeguarding signal set (non-discrimination and accountability), with role-based interpretation differing for non-leaders and leaders.
- Controls (Study 1): firm size (log attorneys), international operations dummy, leverage ratio (associate-to-partner), diversity of non-leaders and of leaders (Blau's index), firm and year fixed effects.
...
Investing in resource practices alone is insufficient — and potentially counterproductive — for retaining women and racialized employees. To reduce non-leader turnover, organizations must avoid mixed safeguarding signals; the ideal configuration pairs resource practices with both high non-discrimination and high accountability; if all three cannot be supported, leaders' retention is best protected by emphasizing accountability practices in particular. Managers should recognize that beneficiaries and implementers interpret the same diversity-practice bundle through different lenses (fair-treatment concerns vs. personal relevance), so communication and program design should address both.
