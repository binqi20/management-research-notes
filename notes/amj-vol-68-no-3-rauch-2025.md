---
id: amj-vol-68-no-3-rauch-2025
title: "Between War and Peace: How Boredom Shapes the Enactment of Idealized Futures in Extreme Contexts"
authors:
  - "Rauch, M."
year: 2025
journal: "Academy of Management Journal"
doi: "https://doi.org/10.5465/amj.2023.0618"
volume: 68
issue: 3
pages: "475-506"

source: "AMJ/vol-68-no-3"
pdf_path: "library/AMJ/vol-68-no-3/pdfs/Rauch 2025 Between War and Peace How Boredom Shapes the Enactment of Idealized Futures in Extreme Contexts.pdf"
...
theory: ["futures and future-making", "existential boredom", "imaginaries", "temporal work", "morality and meaning at work"]
topics: ["qualitative-methods", "meaningful-work", "emotions-at-work", "grand-challenges"]
unit_of_analysis: "individual"
level_of_theory: "micro"
dependent_variable_family: "social"
methods: "Inductive qualitative study using grounded-theory analysis (Strauss & Corbin, 1990) of 63 unsolicited personal diaries (kept for 31 months to 9 years) of UN peacekeeping officers, supplemented by 69 interviews, 397 hours of nonparticipant observations on a UNMISS mission in South Sudan (2019), and 1,896 internal/archival documents; three-stage open, axial, and theoretical coding in NVivo across five temporal phases (pre-deployment to post-deployment)."
sample:
  industry: "United Nations peacekeeping (UNMISS, MONUSCO, MINUSCA, UNIFIL, MINUSMA, UNFICYP, MINURSO, UNMIK)"
  country: "Active missions in Central African Republic, Democratic Republic of the Congo, and South Sudan; with comparative material from Mali, Lebanon, Cyprus, Western Sahara, Kosovo"
  time_period: "Diaries span 2013-2018 (deployments); fieldwork in South Sudan in 2019; interviews 2018-2021"
  units: "UN peacekeeping officers across hierarchical levels, plus seven additional UN personnel (coordinators, HQ staff)"
  n: "63 diarists; 69 interviews (62 with diarists + 7 others); 397 hours of nonparticipant observations; 1,896 documents"

evidence:
  sample_n: "63 personal diaries written by United Nations"
  sample_country: "Republic of Congo, and South Sudan."
  sample_industry: "UN peacekeeping officers"
  sample_time_period: "between 2013 and 2018"
...
- Two divergent pathways:
  - Boredom-induced adjustments (embracing): situational adjustment of moral values, redefining the meaning of the idealized future, and anchoring temporal orientation in the present reality.
  - Boredom-induced adherence (renouncing): clinging to morals, maintaining the meaning of the idealized future, and anchoring temporal orientation in the distant idealized future.
...
Organizations pursuing grand visions or idealized futures (peacekeeping, humanitarian, climate) should identify root causes of worker boredom and treat existential boredom as a signal worth engaging with rather than suppressing. Aligning the meaning of work with local realities — rather than insisting on absolute ideals — supports adoption of context-appropriate practices, retention, and worker pride. The findings translate to less extreme settings (e.g., educators experiencing repetitive content) where reframing meaning can restore engagement.

**Limitations**
The study is bounded by its access to diaries, observations, and interviews from UN peacekeepers on their first missions, with individual traits like resilience deliberately not analyzed to protect anonymity. The author did not study how reflections might evolve after returning home, and the sample, though demographically varied, is specific to UN peacekeeping; generalizability to other extreme or non-extreme settings warrants further empirical attention. The paper also does not rigorously analyze organizational retention, relying on indicative patterns.

**Future Research**
Future work should extend the analysis to a broader emotional palette beyond boredom (anger, frustration, contentment, pride) and explore cross-occupational differences in responses to existential and situational boredom in both traditional and less traditional settings. Researchers could connect these findings to disengagement in less extreme contexts, such as employee engagement with corporate social responsibility initiatives, and probe how technology — particularly AI taking over repetitive, well-codified work — reshapes the antecedents and experience of existential boredom.

**APA 7th Citation**
Rauch, M. (2025). Between war and peace: How boredom shapes the enactment of idealized futures in extreme contexts. *Academy of Management Journal*, 68(3), 475-506. https://doi.org/10.5465/amj.2023.0618
