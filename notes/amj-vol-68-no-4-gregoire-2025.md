...
doi: "https://doi.org/10.5465/amj.2025.4004"
volume: 68
issue: 4
pages: "669-679"
...
theory: ["theory-method alignment"]
topics: ["quantitative-methods", "theory-development", "philosophy-of-science"]
unit_of_analysis: "na"
level_of_theory: "na"
dependent_variable_family: "na"
methods: "Editorial advice piece drawing on collective experience as authors and editors, with examples from past AMJ Best Paper and Impact Award finalists and winners; no empirical analysis."
sample:
...
# Compelling Empirics in Quantitative Studies

**Abstract**
FROM THE EDITORS COMPELLING EMPIRICS IN QUANTITATIVE STUDIES
...
Authors of quantitative submissions should ground research designs in real-world phenomena, justify data and measurement choices by their fit to theoretical constructs, articulate a clear strategic purpose for multi-study designs, theorize the form of change before designing longitudinal studies, complement statistical significance with discussion of effect magnitude and practical meaning, and ensure that crowdsourced or large-sample data come with explicit quality and attentiveness checks.

**Limitations**
Not reported in paper

**Future Research**
The editorial encourages authors to consider preregistering analysis plans (even during revision), to develop theories about the form of change before collecting longitudinal data, to use experimental mediation designs that test causal steps directly rather than relying on measured-mediator analyses, and to integrate qualitative observations as fully integrated strategies rather than convenient afterthoughts to quantitative findings.

**APA 7th Citation**
Grégoire, D. A., Tröster, C., Kotha, R., Zhu, J., Farh, C., Roberson, Q., & Gruber, M. (2025). Compelling empirics in quantitative studies. *Academy of Management Journal*, 68(4), 669–679. https://doi.org/10.5465/amj.2025.4004
