---
id: amj-vol-68-no-4-petriglieri-2025
...
doi: "https://doi.org/10.5465/amj.2024.0061"
volume: 68
issue: 4
pages: "707-734"

source: "AMJ/vol-68-no-4"
pdf_path: "library/AMJ/vol-68-no-4/pdfs/Petriglieri 2025 Uprooting Loneliness A Theory of Continuity-Breaking Self-Narrative Change.pdf"
...
theory: ["self-narrative theory", "attachment theory", "relational scripts", "threshold theory", "narrative inquiry", "psychodynamic perspective"]
topics: ["organizational-identity", "emotions-at-work", "leadership-behavior", "ceo-leadership"]
unit_of_analysis: "individual"
level_of_theory: "micro"
dependent_variable_family: "social"
methods: "Inductive, interpretivist qualitative study grounded in narrative inquiry. Data collected over 15 months via 90-120 minute semi-structured video interviews with 61 senior executives recruited from an international business school's alumni population. Pilot interviews with 7 executives preceded the main study. Analysis used iterative first-order, axial, and theoretical coding (Locke, 2001; Salda~na, 2009), case summaries, narrative causality (Carton, 2018), and circling between data and the literatures on self-narratives, work loneliness, and attachment. Theoretical saturation was reached at interview 46; data collection stopped at 61."
sample:
  industry: "Not reported in paper"
  country: "Not reported in paper"
  time_period: "15 months of data collection (specific calendar dates not reported); informants reported persistent loneliness experiences of at least two years' duration"
  units: "Senior executives (e.g., CEOs, CFOs, CHROs, CMOs, COOs, partners, presidents, directors) who self-reported sustained or repeated loneliness in their work roles"
  n: "61 executives in the formal study (28 holding constraining self-narratives, 24 having transitioned to connecting self-narratives, 9 in the midst of change), plus 7 pilot interviewees"

evidence:
  sample_n: "Semi-structured interviews with 61 senior executives over 15 months"
  sample_country: "Not reported in paper"
  sample_industry: "Not reported in paper"
  sample_time_period: "Semi-structured interviews with 61 senior executives over 15 months"
...
- Process / phases: (1) constraining self-narrative maintained through enactment of self-isolating behavior, rhetorical justification of loneliness as the price of success, and relational compensation outside work; (2) crossing an emotional threshold when loneliness becomes intolerable; (3) self-referential insight that loneliness is partly an agentic construction; (4) translating insight into experimental relational actions, or hitting an impasse driven by fear; (5) oscillation between competing relational scripts; (6) connecting self-narrative in which the alternative script replaces the original and other stories of self are updated.
- Practices: enacting guarded/self-isolating behaviors vs. open/affiliative behaviors; rhetorical justification; relational compensation in nonwork life; gradual experimentation ("almost by stealth"); seeking help; building "circles of confidence."
...
Workplace interventions that focus solely on the work environment are unlikely to be sufficient to combat the loneliness epidemic. Organizations should pair opportunities to connect with interventions that help workers question their assumptions about who they need to be and how they need to act in relation to others at work, and create opportunities for self-reflection. Senior executives, in particular, should recognize that the bargains they have made between self-reliance and success can produce persistent loneliness, and that humanizing oneself at work can paradoxically aid leadership effectiveness.

**Limitations**
The findings are drawn from an elite sample of executives recruited from an international business school's alumni population, raising questions about generalizability to non-executives or to workers with job (rather than career) orientations. The method is purposefully subjective and relies on narrative causality, so it cannot establish that the changes described actually occurred objectively as informants recounted them. Data were collected at a single point in time rather than longitudinally, although the authors mitigate this by sampling informants at different stages of the process.

**Future Research**
Future studies could investigate cultural and collective dynamics of continuity-breaking self-narrative change — for example, whether senior executives' updated self-narratives diffuse to surrounding workers, paralleling contagion effects in loneliness. Researchers could examine self-narrative change among workers at different career stages, compare workers with different orientations to work, and explore how loneliness in one life domain affects relational behavior in others. Scholars are also encouraged to examine threshold-crossing levels of other social emotions (anger, shame, envy) as triggers of self-narrative change, and to investigate interindividual variance in whether and when people cross such thresholds.

**APA 7th Citation**
Petriglieri, J. L., & Sheprow, E. (2025). Uprooting loneliness: A theory of continuity-breaking self-narrative change. *Academy of Management Journal*, 68(4), 707-734. https://doi.org/10.5465/amj.2024.0061
