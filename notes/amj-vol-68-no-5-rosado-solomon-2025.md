...
**Mechanism Process**
- IV(s): Onset of mental illness symptoms (mood and anxiety disorder symptoms such as low mood, irritability, panic, lethargy, trouble concentrating)
- DV(s): Wellness outcomes (survival, subjective well-being, reduction of negative emotions) and work-related outcomes (acceptable task performance, retention, image preservation)
- Mediators: Three mechanisms — suffering reduction, image preservation, and distraction
- Moderators: Type of (dis)engagement action (physical, task, social); contextual constraints (workplace norms, time pressures); self-awareness of symptoms

When symptoms arise, employees with mental illness agentically enact temporary shifts in work involvement rather than passively suffering or withdrawing permanently. They pull back through physical, task, or social disengagement, or push in through increased physical, task, or social engagement. These (dis)engagement actions operate through three mechanisms — reducing the suffering of aversive symptoms, preserving a professional image to avoid stigma and discrimination, and distracting attention away from symptoms — producing beneficial wellness outcomes and acceptable (rather than optimal) work performance. The model frames disengagement not as disaffection or burnout but as a deliberate, responsible, short-duration strategy that lets employees preserve both their jobs and their well-being.
