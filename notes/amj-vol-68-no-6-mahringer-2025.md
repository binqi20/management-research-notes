---
id: amj-vol-68-no-6-mahringer-2025
...
doi: "https://doi.org/10.5465/amj.2022.0853"
volume: 68
issue: 6
pages: "1300-1327"
...
theory: ["routine dynamics", "interdependence theory (Thompson 1967)", "practice and process ontology", "organizational design"]
topics: ["organizational-behavior-hrm", "teams-collaboration", "theory-development", "innovation-management"]
unit_of_analysis: "team"
level_of_theory: "meso"
dependent_variable_family: "na"
methods: "12-month ethnographic single-case study of the reorganization of agile (Scrum) software development at a medium-sized high-tech manufacturing firm ('Technology Innovation Corporation'). Data comprise ~1,000 pages of fieldnotes and 122 hours of audio from 2-3 days/week of observation, 35 formal interviews (30 during fieldwork plus 5 follow-ups two years later), ~6,300 pages of documents and ~2,000 emails, and ~163,000 digital trace actions from Jira. Inductive process analysis in five steps: identifying routine clusters, constructing an event timeline of reorganization, classifying emerging interdependencies via Thompson's (1967) pooled/sequential/reciprocal typology, inductively coding four interface design practices, and modeling the dynamics linking reorganization, interdependencies, and interface design work across three analytical periods."
sample:
  industry: "High-tech manufacturing (agile software development for industrial machines such as cellphone-display cutters and laser battery-pack welders)"
  country: "Germany"
...
The paper advances routine dynamics, interdependence, and organizational design research by reframing interface design as an endogenous, iterative process of creating and harmonizing emergent interdependencies, performed by routine participants rather than by detached exogenous architects. It uncovers "interface design work" as four distinct practices differentiated along two dimensions — durability (transitory vs. patterning) and design elements (artifacts vs. timing) — and theorizes a mutually constitutive relationship between resourcing, patterning, and performing. Third, it unpacks the role of resources in interface design, showing that sharing scarce resources generates pooled interdependencies that can escalate into sequential and reciprocal forms, such that disentangling routine clusters may paradoxically produce heightened forms of entanglement before stable autonomy is achieved.
...
**APA 7th Citation**
Mahringer, C. A., & Danner-Schröder, A. (2025). Autonomous, yet interdependent: Designing interfaces across routine clusters. *Academy of Management Journal*, 68(6), 1300-1327. https://doi.org/10.5465/amj.2022.0853
