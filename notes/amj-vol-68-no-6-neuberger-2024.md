...
**Mechanism Process**
- IV(s): Make-or-break audience expectations (expedited achievement pressures and standardized evaluation metrics imposed by the accelerator); founders' initial venture-work response (accommodation, selective adherence, or assertive resistance).
- DV(s): New venture legitimation pathway (obedient, pragmatic, rebellious) and ultimate legitimacy evaluation from the audience (positive vs. negative).
- Mediators: Founders' prospective achievement emotions (frustration, hopelessness, assurance, anticipatory joy) and subsequent relational venture work (symbolic distancing, symbolic embedding, symbolic reuniting).
- Moderators: Founders' prior entrepreneurial/work experience and emotional resilience, which shape their capacity to challenge audience demands.

Accelerators create an intense evaluative environment that generates founder "legitimacy concerns" and triggers adaptive venture work. The form this work takes (obedient accommodation, selective adherence, or assertive resistance) elicits distinct prospective achievement emotions: reluctant accommodation fosters hopelessness, while deviant adaptive work engenders assurance and anticipatory joy. These emotional states, often paired as "moral batteries," channel subsequent relational venture work through which founders symbolically distance from, embed in, or reunite with the audience. Counterintuitively, obedient accommodation tends to spiral into negative evaluations, whereas selective adherence and assertive resistance more often yield positive legitimacy outcomes.
