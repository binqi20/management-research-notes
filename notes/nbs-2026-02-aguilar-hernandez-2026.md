---
id: nbs-2026-02-aguilar-hernandez-2026
...
text_path: "library/NBS/2026-02/text/Aguilar-Hernandez 2026 Is academia addressing relevant questions to support a circularity transition in Latin America and the Caribbean.txt"
...
# Is academia addressing relevant questions to support a circularity transition in Latin America and the Caribbean?
...
**Research Question**
Is academia addressing relevant questions to support the Circular Economy transition in Latin America and the Caribbean? Specifically, the paper determines (1) which stakeholder questions are being directly or indirectly addressed in current literature, (2) which areas remain underexplored or overlooked, and (3) how research agendas can be better aligned to support CE implementation.
...
The paper advances the debate on the societal role of academic research in sustainability transitions by providing an empirically grounded, LAC-specific assessment of alignment between stakeholder priorities and academic CE research. It contributes a Research Alignment Ratio methodology for systematically comparing thematic frequencies across stakeholder and literature datasets, and identifies three key drivers of misalignment (science communication, priority setting, and transdisciplinarity). It positions LAC as a Global South case study that invites the global CE research community to reflect on whether current research agendas adequately address pressing stakeholder needs while preserving academia's critical independence.
